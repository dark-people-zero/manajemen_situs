...
<div>
    ...
    <div class="main-content app-content">
        <div class="main-container container-fluid p-0">
            <div>
                @if ($urlActive)
                    <iframe src="{{$urlActive}}" id="iframe-preview" class="iframe-preview {{$prevActive == 'mobile' ? 'iframe-preview--mobile' : ''}}" width="100%"></iframe>
                @else
                    <div class="defaultInfo" id="defaultInfo">
                        <div class="d-flex align-items-center justify-content-center h-100">
                            <h4 class="d-flex">Silahkan klick icon <a class="demo-icon new nav-link mx-2" href="javascript:void(0);" data-bs-toggle="sidebar-right" data-bs-target=".sidebar-right">
                            ...
                            </a> untuk melihat dan mengatur situs.</h4>
                        </div>
                    </div>
                @endif
            </div>
