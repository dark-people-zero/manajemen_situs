...
<head>
    ...
    <title>OPPATOTO.COM | Agen Togel Online Aman Terpercaya</title>
    <meta name="keywords"
        content="Agen Togel Online Aman, Togel Online Aman Terpercaya,  Agen Togel Aman Terpercaya, Agen Togel Online Terpercaya" />
    <meta name="description"
        content="OPPATOTO.COM adalah Agen Togel Online Aman Terpercaya yang dilengkapi dengan permainan togel online terbesar seperti togel Hongkong, Singapura, Sydney, Totomacau, Nevada dan masih banyak lagi. Oppatoto juga menyajikan permainan live casino online terpopuler seperti Roulette, Baccarat, Sicbo, dan masih banyak lagi. Sistem keamanan yang canggih, proses Deposit dan Withdraw yang mudah serta didukung oleh customer service yang siap melayani anda 7x24 jam Nonstop." />
    <meta name="google-site-verification" content="E4Cww0YEq0_fjyQWKRV-XMbfq52tzF1RuWUXZwxqfSE" />
    <meta name="google-site-verification" content="jZCrjFbx8nlPepv4dHgp3kXwW6Tx4EDrqw_OIrn5hS4" />
    ...
    <link rel="icon" type="image/ico"
        href="{{ asset('situs/assets/oppa_toto/desktop/assets/img/akx/favicon9847.png?v=1666377903') }}" />

    <link href="{{ asset('situs/assets/oppa_toto/desktop/assets/css/vendor/bootstrap/bootstrap.min.css') }}"
        rel="stylesheet">
    <link href="{{ asset('situs/assets/oppa_toto/desktop/assets/css/font-awesome.min.css') }}" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('situs/assets/oppa_toto/desktop/assets/css/vendor/animate/animate.css') }}">

    <link rel="stylesheet"
        href="{{ asset('situs/assets/oppa_toto/desktop/assets/css/vendor/bootstrap-checkbox.css') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/oppa_toto/desktop/assets/css/vendor/ribbons/3d-corner-ribbons.css') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/oppa_toto/desktop/assets/js/vendor/text-rotator/css/simpletextrotator.css') }}">
    <link rel="stylesheet" href="{{ asset('situs/assets/oppa_toto/desktop/assets/css/fonts.css') }}">

    <!-- Important Owl stylesheet -->
    <link rel="stylesheet"
        href="{{ asset('situs/assets/oppa_toto/desktop/assets/js/vendor/owl-carousel/css/owl.carouselca71.css?id=889') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/oppa_toto/desktop/assets/js/vendor/owl-carousel/css/owl.theme.css') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/oppa_toto/desktop/assets/js/vendor/owl-carousel/css/owl.transitions.css') }}">

    <link rel="stylesheet"
        href="{{ asset('situs/assets/oppa_toto/desktop/assets/js/vendor/nivo-lightbox/css/nivo-lightbox.css') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/oppa_toto/desktop/assets/js/vendor/nivo-lightbox/css/themes/default/default.css') }}"
        type="text/css" />
    <!-- ADDITIONAL CSS -->
    <link rel="stylesheet" href="{{ asset('situs/assets/oppa_toto/desktop/assets/css/additionalffaf.css?v=1.4') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('situs/assets/oppa_toto/desktop/assets/css/game_compressed_ic9847.css?v=1666377903') }}">
    <!-- CUSTOM STYLE -->
    <link rel="stylesheet"
        href="{{ asset('situs/assets/oppa_toto/desktop/assets/css/akx/akx29847.css?v=1666377903') }}">
...
<body>
            ...
            var e = {
                ...
                init: function() {
                    ...
                    n.async = !0, n.type = "text/javascript", n.src =
                        "situs/assets/oppa_toto/desktop/assets/tracking.js", t.head.appendChild(
                            n)
                }
            };
    ...
    <noscript><a href="https://www.livechat.com/chat-with/14617200/" rel="nofollow">Chat with us</a>, powered by <a
    ...
    <div style="position: absolute; float: right; z-index: 999999; right: 12%;top: 0;">
        <a href="#"
            onclick="window.open('https://form.6mbr.com/?webname=oppatoto176.com&amp;lang=id','kritik_saran', 'width=600, height=1000');">
            <img src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/feedback2.png') }}" width="115px;">
        </a>
    </div>
    <!-- BEGIN NAVBAR -->
                ...
                <div class="row">
                    <div class="col-sm-7" style="text-align:right;width: 62.333333%;margin-left:190px;">
                        <form action='#' METHOD="post"
                            ...
                            <script type="text/javascript" src="{{ asset('situs/assets/oppa_toto/desktop/tgsecure/vbulletin_md5.js') }}"></script>
                ...
                <div class="col-sm-3 blog-sidebar">
                    ...
                    <div class="sidebar-button" align="center">
                        <a class="btn btn-theme"
                            href="javascript:void(0);">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Daftar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                    </div>
                    <!-- END NAV -->
                    <div class="results">
                        ...
                        <div class="vertical-slider">
                            <div class="cycle-slideshow" data-cycle-fx="scrollVert" data-cycle-timeout="3000"
                                ...
                                <div style="width:100%">
                                    ...
                                    <div class="results-detail"><span class="results-pool">KENTUCKMID</span><span
                                ...
                                <div style="width:100%">
                                    ...
                                    <div class="results-detail"><span class="results-pool">BANGKOK 0130</span><span
                                            class="results-number">0598</span></div>
                                </div>
                                <div>
                    ...
                    <div class="results">
                        ...
                        <div class="news-detail">
                            <div class="latest-news"><a href="javascript:void(0);"><span style="color:#ffb400">JADWAL
                                        BANK
                                        DAN MAINTENANCE</span></a><br><span class="dates">2022-09-14 21:37:17</span>
                            </div>
                            <div class="latest-news"><a href="javascript:void(0);"><span style="color:#ffb400">JADWAL
                                        PASARAN
                                        TOGEL</span></a><br><span class="dates">2022-09-24 13:41:15</span></div>
                            <div class="latest-news"><a href="javascript:void(0);"><span style="color:#ffb400">FAQ
                                        OPPATOTO</span></a><br><span class="dates">2022-09-19 22:50:35</span></div>
                        </div>
                    </div>
                </div> <!-- BEGIN SLIDER -->
                <div class="col-sm-9 blog-posts">
                    <div id="slider" class="slider">
                        ...
                        <div class="owl-carousel owl-theme">
                            ...
                            <div class="item">
                                <img src="{{ asset('situs/assets/oppa_toto/desktop/images/slider/oppatoto_sliderweb_allbonus.jpg') }}"
                                    width="840px" height="482" />
                            </div>
                            <div class="item">
                                <img src="{{ asset('situs/assets/oppa_toto/desktop/images/slider/oppatoto_sliderweb_nominalunik.jpg') }}"
                                    width="840px" height="482" />
                            </div>
                            <div class="item">
                                <img src="{{ asset('situs/assets/oppa_toto/desktop/images/slider/oppatoto_sliderweb_tipebet2.jpg') }}"
                                    width="840px" height="482" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="latest-results" class="margin-top-15">
                        ...
                        <div class="owl-carousel owl-theme gameicon">
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1') }}"
                            ...
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    ...
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/icon/icon-SYDNEYf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/icon/icon-hongkongf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/icon/icon-BULLSEYEf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    ...
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/icon/icon-CHINAf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'></div>
                            ...
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    ...
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/icon/icon-MAGNUM4Df9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'></div>
                            ...
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    ...
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/icon/icon-SINGAPOREf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'></div>
                            ...
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    ...
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/icon/icon-24DSPINc619.jpg?v=1.0') }}">
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/icon/icon-D6c619.jpg?v=1.0') }}">
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/icon/icon-TMc619.jpg?v=1.0') }}">
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/icon/icon-24dc619.jpg?v=1.0') }}">
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/icon/icon-RLc619.jpg?v=1.0') }}">
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/icon/icon-SDc619.jpg?v=1.0') }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-9">
                    ...
                    <div class="owl-carousel owl-theme bankscroll">
                        <div class="item bank" data-animation="fadeIn">
                            ...
                            <img src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/bca.png') }}"
                                alt="Bank Central Asia" width="78px" height="24px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="trouble bni"></div>
                            <img src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/bni.png') }}"
                                alt="Bank BNI" width="80px" height="24px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="trouble bri"></div>
                            <img src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/bri.png') }}"
                                alt="Bank BRI" width="85px" height="21px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online"></div>
                            <img src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/BSI.png') }}"
                                alt="BSI" width=86px height=22px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="trouble cimb"></div>
                            <img src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/cimb-2.png') }}"
                                alt="Bank CIMB NIAGA" width=86px height=25px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online dana"></div>
                            <img src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/dana.png') }}"
                                alt="DANA" width="89px" height="25px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online danamon"></div>
                            <img src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/danamon.png') }}"
                                alt="Bank DANAMON" width="85px" height="21px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online"></div>
                            <img src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/GoPay.png') }}"
                                alt="GOPAY" width=86px height=22px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online"></div>
                            <img src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/linkaja.png') }}"
                                alt="LINKAJA" width=86px height=22px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="offline mandiri"></div>
                            <img src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/nofound.html') }}"
                                alt="Bank Mandiri" width="86px" height="25px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online maybank"></div>
                            <img src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/maybank.png') }}"
                                alt="Maybank Indonesia" width=86px height=25px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online"></div>
                            <img src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/ovo.png') }}"
                ...
                <div class="row">
                    <div class="row" style="display: flex;">
                        ...
                        <div class="col-3 col-sm-3">
                            <img src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/idnplay_w.png') }}"
                                style="overflow: inherit !important;width: 100%;padding: 10px;margin-top: 7px;">
                        </div>
                        <div class="col-3 col-sm-3">
                            <img src="{{ asset('situs/assets/oppa_toto/desktop/assets/img/pagcorlogo2.png') }}"
                                style="overflow: inherit !important;width: 100%;padding: 10px;">
                        </div>
                        <div class="col-3 col-sm-3"></div>
                    </div>
                    <div class="col-md-12 copyright">
                        &copy; Copyright 2014 - 2022 <a href="#">oppatoto176.com</a>. All Rights Reserved.
                    </div>
                </div>
            </div>
        </div>
    ...
    <style type="text/css">
        @font-face {
            font-family: Muli;
            src: url(situs/assets/oppa_toto/desktop/assets/fonts/Muli.ttf);
        }
    ...
    <script src="{{ asset('situs/assets/oppa_toto/desktop/assets/js/vendor/modernizr-2.6.2-respond-1.1.0.min.js') }}">
    </script>
    <script src="{{ asset('situs/assets/oppa_toto/desktop/assets/js/jquery.js') }}"></script>
    <script src="{{ asset('situs/assets/oppa_toto/desktop/assets/js/vendor/bootstrap/bootstrap.min.js') }}"></script>
    <script src="{{ asset('situs/assets/oppa_toto/desktop/assets/js/vendor/skrollr/skrollr.min.js') }}"></script>
    <script
        src="{{ asset('situs/assets/oppa_toto/desktop/assets/js/vendor/text-rotator/jquery.simple-text-rotator.js') }}">
    </script>
    <script src="{{ asset('situs/assets/oppa_toto/desktop/assets/js/vendor/owl-carousel/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('situs/assets/oppa_toto/desktop/assets/js/vendor/nivo-lightbox/nivo-lightbox.min.js') }}">
    </script>
    <script src="{{ asset('situs/assets/oppa_toto/desktop/assets/js/vendor/tweet-js/jquery.tweet.min.js') }}"></script>
    {{-- <!-- <script src="{{ asset('situs/assets/oppa_toto/desktop/assets/js/vendor/vticker/jquery.vticker.min.js" ></') }}script> --> --}}
    <script src="{{ asset('situs/assets/oppa_toto/desktop/assets/js/vendor/jflickrfeed/jflickrfeed.min.js') }}"></script>
    <script src="{{ asset('situs/assets/oppa_toto/desktop/assets/js/vendor/appear/jquery.appear.js') }}"></script>
    <script src="{{ asset('situs/assets/oppa_toto/desktop/assets/js/vendor/parallax/jquery.parallax-1.1.3.js') }}">
    </script>
    <script src="{{ asset('situs/assets/oppa_toto/desktop/assets/js/vendor/liScroller/jquery.li-scroller.1.0.js') }}">
    </script>
    <script src="{{ asset('situs/assets/oppa_toto/desktop/assets/js/jquery.cycle2.min.js') }}"></script>
    <script src="{{ asset('situs/assets/oppa_toto/desktop/assets/js/jquery.fixedheadertable.min.js') }}"></script>
    <script src="{{ asset('situs/assets/oppa_toto/desktop/assets/js/stylec619.js?v=1.0') }}"></script>
    <script>
        (function($) {
            "use strict";
    ...
    <script type="text/javascript" src="{{ asset('situs/assets/oppa_toto/desktop/assets/idn/idn-togel-frame.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('situs/assets/oppa_toto/desktop/assets/idn/idn-togel-spa.js') }}">
    </script>
</body>
