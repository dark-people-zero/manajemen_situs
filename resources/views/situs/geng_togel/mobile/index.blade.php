...
<!-- Mirrored from gengtogel176.com/m/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Oct 2022 10:41:42 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
	<title>Situs Agen Togel Online Resmi, Terbaik Dan Terpercaya</title>
<meta name="keywords" content="Situs Agen Togel Online Resmi, Terbaik Dan Terpercaya, Situs Agen Togel Online Resmi, Agen Togel Online Resmi, Togel Online Resmi"/>
<meta name="description" content="Gengtoto adalah Situs Agen Togel Online Resmi, Terbaik Dan Terpercaya. Bandar togel online yang menyediakan pasaran togel singapura, hongkong, sydney, taiwan, dan cambodia."/>
...
form h1, h2, h3, h4, h5, h6 {
	...
	<meta name="apple-mobile-web-app-title" content="gengtogel176 Mobile">
      ...
      <div id="content" class="page-content" data-snap-ignore="true">
        <div class="page-header smartb1">
          <div class="app-container"></div>
                          <a class="smartb2" href="index-2.html"><img class="header-logo2" src="{{ asset('situs/assets/geng_togel/mobile/logo.png') }}" width="130"></a>
                          <div class="buttonlc space smartb3">
                <a href="https://direct.lc.chat/13376160/" class="buttonWrap buttonlc2 button-orange" _blank>Live Chat</a>
              </div>
                  </div>
          ...
          <div class="container main no-bottom">
            <div class="wrapper2">
              ...
              <div>
                ...
                <form action="https://gengtogel176.com/m/index.php" METHOD="post" onsubmit="md5hash(entered_password, vb_login_md5password, vb_login_md5password_utf, 0)">
                  ...
                  <div>
                    <a href="forget-password.html" class="note right underline">Lupa password?</a>
                      ...
                      <a href="https://gengtogel176.com/lite/index.php" class="note left underline">Lite Mode</a>
                ...
                <div class="buttonjoin">
                  <a href="https://gengtogel176.com/m/register.php" class="buttonWrap buttong button-green contactSubmitButton">Daftar</a>
                </div>
                              </div>
            </div>
...
.owl-wrapper .owl-item .bank .online.smb-mandiri{
        ...
        background: url('../../cdn.areabermain.club/gengtoto/images/banks/gengtogel_online_mandiri.gif') 0px 0px no-repeat !important;
}
.owl-wrapper .owl-item .bank .online.smb-cimb{
        width: 168px !important;
        height: 80px !important;
        background: url('../../cdn.areabermain.club/gengtoto/images/banks/gengtogel_online_cimb.gif') 0px 0px no-repeat !important;
}
.btn-close{
    font-weight: bold;
    font-size: 25px;
...
<div id='slider-hasil'><div class="slider">
                ...
                <div class="results">
                  ...
                  <div class="pool-date">2022-10-22</div>
                  <div class="pool-result">8914</div>
                </div>
...
<div>
  ...
  <div class="bank">
    ...
    <img src="{{ asset('situs/assets/geng_togel/mobile/bca.webp') }}" />
  </div>
  <div class="bank">
    <img src="{{ asset('situs/assets/geng_togel/mobile/green-dot.GIF') }}" />
    <img src="{{ asset('situs/assets/geng_togel/mobile/bni.webp') }}" />
  </div>
  <div class="bank">
    <img src="{{ asset('situs/assets/geng_togel/mobile/green-dot.GIF') }}" />
    <img src="{{ asset('situs/assets/geng_togel/mobile/bri.webp') }}" />
  </div>
  <div class="bank">
    <img src="{{ asset('situs/assets/geng_togel/mobile/green-dot.GIF') }}" />
    <img src="{{ asset('situs/assets/geng_togel/mobile/cimb.webp') }}" />
  </div>
  <div class="bank">
    <img src="{{ asset('situs/assets/geng_togel/mobile/green-dot.GIF') }}" />
    <img src="{{ asset('situs/assets/geng_togel/mobile/danamon.webp') }}" />
  </div>
  <div class="bank">
    <img src="{{ asset('situs/assets/geng_togel/mobile/green-dot.GIF') }}" />
  ...
  <div class="bank">
    <img src="{{ asset('situs/assets/geng_togel/mobile/green-dot.GIF') }}" />
    <img src="{{ asset('situs/assets/geng_togel/mobile/maybank.webp') }}" />
  </div>
  <div class="bank">
    <img src="{{ asset('situs/assets/geng_togel/mobile/green-dot.GIF') }}" />
    <img src="{{ asset('situs/assets/geng_togel/mobile/ovo.webp') }}" />
  </div>
  <div class="bank">
    <img src="{{ asset('situs/assets/geng_togel/mobile/green-dot.GIF') }}" />
    <img src="{{ asset('situs/assets/geng_togel/mobile/gopay.webp') }}" />
  </div>
  <div class="bank">
    <img src="{{ asset('situs/assets/geng_togel/mobile/green-dot.GIF') }}" />
    <img src="{{ asset('situs/assets/geng_togel/mobile/dana.webp') }}" />
  </div>
  <div class="bank">
    <img src="{{ asset('situs/assets/geng_togel/mobile/green-dot.GIF') }}" />
    <img src="{{ asset('situs/assets/geng_togel/mobile/linkaja.webp') }}" />
  </div>
  <div class="bank">
    <img src="{{ asset('situs/assets/geng_togel/mobile/green-dot.GIF') }}" />
    <img src="{{ asset('situs/assets/geng_togel/mobile/bsi.webp') }}" />
  </div>     </div>
</div>
  </div>
</div>
...
<div class="row" style="display: flex;">
  <div class="col-6 col-sm-6">
    <img src="{{ asset('situs/assets/geng_togel/mobile/idnplay_w.png') }}" style="overflow: inherit !important;width: 100%;padding: 10px;margin-top: 7px;">
  </div>
  <div class="col-6 col-sm-6">
    <img src="{{ asset('situs/assets/geng_togel/mobile/pagcorlogo2.png') }}" style="overflow: inherit !important;width: 100%;padding: 10px;">
  </div>
    </div>
    <div class="footer">
      <div class="wrapper">
        <div class="center-text">&copy; 2014 - 2022 gengtogel176. All Rights Reserved | 18+</div>
      </div>
    </div>
  </div>
</div></body>
