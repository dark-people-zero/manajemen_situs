...
<head>
    ...
    <link href="{{ asset('situs/assets/zia_togel/desktop/assets/css/vendor/bootstrap/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{ asset('situs/assets/zia_togel/desktop/assets/css/font-awesome.min.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('situs/assets/zia_togel/desktop/assets/css/vendor/animate/animate.css')}}">

    <link rel="stylesheet" href="{{ asset('situs/assets/zia_togel/desktop/assets/css/vendor/bootstrap-checkbox.css')}}">
    <link rel="stylesheet" href="{{ asset('situs/assets/zia_togel/desktop/assets/css/vendor/ribbons/3d-corner-ribbons.css')}}">
    <link rel="stylesheet" href="{{ asset('situs/assets/zia_togel/desktop/assets/js/vendor/text-rotator/css/simpletextrotator.css')}}">
    <link rel="stylesheet" href="{{ asset('situs/assets/zia_togel/desktop/assets/css/fonts.css')}}">

    <!-- Important Owl stylesheet -->
    <link rel="stylesheet" href="{{ asset('situs/assets/zia_togel/desktop/assets/js/vendor/owl-carousel/css/owl.carouselca71.css?id=889')}}">
    <link rel="stylesheet" href="{{ asset('situs/assets/zia_togel/desktop/assets/js/vendor/owl-carousel/css/owl.theme.css')}}">
    <link rel="stylesheet" href="{{ asset('situs/assets/zia_togel/desktop/assets/js/vendor/owl-carousel/css/owl.transitions.css')}}">

    <link rel="stylesheet" href="{{ asset('situs/assets/zia_togel/desktop/assets/js/vendor/nivo-lightbox/css/nivo-lightbox.css')}}">
    <link rel="stylesheet" href="{{ asset('situs/assets/zia_togel/desktop/assets/js/vendor/nivo-lightbox/css/themes/default/default.css')}}" type="text/css" />
    <!-- ADDITIONAL CSS -->
    <link rel="stylesheet" href="{{ asset('situs/assets/zia_togel/desktop/assets/css/additionalffaf.css?v=1.4')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('situs/assets/zia_togel/desktop/assets/css/game_compressed_ica7ff.css?v=1664975510')}}">
    <!-- CUSTOM STYLE -->
    <link rel="stylesheet" href="{{ asset('situs/assets/zia_togel/desktop/assets/css/auo/auo2a7ff.css?v=1664975510')}}">
...
<body>
            ...
            <div class="row">
                ...
                <div class="col-sm-3 blog-sidebar">
                    ...
                    <ul class="nav menu sidebar-nav">
                        ...
                        <li><a href="#"><i class="fa fa-question-circle"></i>&nbsp;&nbsp;Cara Bermain</a></li>
                        <li><a href="#"><i class="fa fa-line-chart"></i>&nbsp;&nbsp;History Nomor</a></li>
                        <li><a href="#"><i class="fa fa-newspaper-o"></i>&nbsp;&nbsp;Buku Mimpi</a></li>
                        <li><a href="#"><i class="fa fa-users"></i>&nbsp;&nbsp;Referral</a></li>
                        <li><a href="#"><i class="fa fa-comments-o"></i>&nbsp;&nbsp;Hubungi Kami</a></li>
                        <li><a href="#"><i class="fa fa-calendar"></i>&nbsp;&nbsp;Lupa Password</a></li>
                            ...
                            <div class="cycle-slideshow" data-cycle-fx="scrollVert" data-cycle-timeout="3000"
                                ...
                                <div>
                                    ...
                                    <div class="results-detail"><span class="results-pool"
                                            ...
                                            Macau</span><span class="results-number">2946</span></div>
                                    <div class="results-detail"><span class="results-pool"
                                ...
                                <div>
                                    <div class="results-detail"><span class="results-pool"
                                            ...
                                            <div class='rl-ic' style="background-position:-125px 0px"></div>
                                        </span></div>
                                    <div class="results-detail"><span class="results-pool"
                    ...
                    <div class="results">
                        ...
                        <div class="news-detail">
                            <div class="latest-news"><a href="#">
                                    <marquee behavior="alternate"><strong>
                                            <font
                                                style="text-shadow: 0px 0px 5px rgb(255 191 0);color: #ffffff; font-size:
                        15px ">
                                                ***🏆 HASIL RESULT TOGEL 🏆***</font>
                                        </strong></marquee>
                                </a><br><span class=" dates">
                                    2022-09-24 16:11:23</span></div>
                            <div class="latest-news"><a href="#">
                                    <marquee behavior="alternate"><strong>
                                            <font
                                                style="text-shadow: 0px 0px 5px rgb(255 191 0);color: #ffffff;  font-size:
                        15px ">
                                                *⏰*⚠️* JADWAL BANK OFFLINE & MAINTENANCE *⏰*⚠️*</font>
                                        </strong></marquee>
                                </a><br><span class="
                        dates">2022-10-05 00:22:19</span></div>
                            <div class="latest-news"><a href="#">
                                    <marquee behavior="alternate"><strong>
                                            <font
                ...
                <div class="col-sm-9 blog-posts">
                    <div id="slider" class="slider">
                        <div class="owl-carousel owl-theme">
                            ...
                            <div class="item">
                                <img src="{{ asset('situs/assets/zia_togel/desktop/images/ziatogel_sliderweb_tipebet.jpg') }}" width="840px" height="482" />
                            </div>
                            <div class="item">
                                <img src="{{ asset('situs/assets/zia_togel/desktop/images/ziatogel_sliderweb_prosesdeposit.jpg') }}" width="840px"
                                    height="482" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="latest-results" class="margin-top-15">
                        ...
                        <div class="owl-carousel owl-theme gameicon">
                            ...
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/zia_togel/desktop/assets/img/icon/icon-BULLSEYEf9e3.jpg?v=1.1')}}" width='210px' height='210px'>
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/zia_togel/desktop/assets/img/icon/icon-SYDNEYf9e3.jpg?v=1.1')}}" width='210px' height='210px'>
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/zia_togel/desktop/assets/img/icon/icon-CHINAf9e3.jpg?v=1.1')}}" width='210px' height='210px'>
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/zia_togel/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1')}}" width='210px' height='210px'>
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/zia_togel/desktop/assets/img/icon/icon-SINGAPOREf9e3.jpg?v=1.1')}}" width='210px' height='210px'>
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/zia_togel/desktop/assets/img/icon/icon-MAGNUM4Df9e3.jpg?v=1.1')}}" width='210px' height='210px'>
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/zia_togel/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1')}}" width='210px' height='210px'>
                            </div>
                            ...
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/zia_togel/desktop/assets/img/icon/icon-hongkongf9e3.jpg?v=1.1')}}" width='210px' height='210px'>
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/zia_togel/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1')}}" width='210px' height='210px'>
                            </div>
                            ...
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/zia_togel/desktop/assets/img/icon/icon-TMc619.jpg?v=1.0')}}"></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/zia_togel/desktop/assets/img/icon/icon-24dc619.jpg?v=1.0')}}"></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/zia_togel/desktop/assets/img/icon/icon-RLc619.jpg?v=1.0')}}"></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="owl-carousel owl-theme bankscroll">
                        ...
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online"></div><img src="{{ asset('situs/assets/zia_togel/desktop/assets/img/BSI.png')}}" alt="BSI" width=86px
                                height=22px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                        ...
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online"></div><img src="{{ asset('situs/assets/zia_togel/desktop/assets/img/GoPay.png')}}" alt="GOPAY" width=86px
                                height=22px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online"></div><img src="{{ asset('situs/assets/zia_togel/desktop/assets/img/linkaja.png')}}" alt="LINKAJA" width=86px
                                height=22px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                        ...
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online"></div><img src="{{ asset('situs/assets/zia_togel/desktop/assets/img/ovo.png')}}" alt="OVO" width=86px
                                height=22px>
                        </div>
                    </div>
                    <div>
                    ...
                    <div class="row">
                        <div class="row" style="display: flex;">
                            ...
                            <div class="col-3 col-sm-3">
                                <img src="{{ asset('situs/assets/zia_togel/desktop/assets/img/idnplay_w.png')}}"
                                    style="overflow: inherit !important;width: 100%;padding: 10px;margin-top: 7px;">
                            </div>
                            <div class="col-3 col-sm-3">
                                <img src="{{ asset('situs/assets/zia_togel/desktop/assets/img/pagcorlogo2.png')}}"
                                    style="overflow: inherit !important;width: 100%;padding: 10px;">
                            </div>
                            <div class="col-3 col-sm-3"></div>
                        </div>
                        <div class="col-md-12 copyright">
                            &copy; Copyright 2014 - 2022 <a href="#">ziatogel168.net</a>. All Rights Reserved.
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="{{ asset('situs/assets/zia_togel/desktop/assets/js/vendor/modernizr-2.6.2-respond-1.1.0.min.js')}}"></script>
    ...
    <script src="{{ asset('situs/assets/zia_togel/desktop/assets/js/vendor/skrollr/skrollr.min.js')}}"></script>
    <script src="{{ asset('situs/assets/zia_togel/desktop/assets/js/vendor/text-rotator/jquery.simple-text-rotator.js')}}"></script>
    <script src="{{ asset('situs/assets/zia_togel/desktop/assets/js/vendor/owl-carousel/owl.carousel.min.js')}}"></script>
    <script src="{{ asset('situs/assets/zia_togel/desktop/assets/js/vendor/nivo-lightbox/nivo-lightbox.min.js')}}"></script>
    <script src="{{ asset('situs/assets/zia_togel/desktop/assets/js/vendor/tweet-js/jquery.tweet.min.js')}}"></script>
    <!-- <script src="{{ asset('situs/assets/zia_togel/desktop/assets/js/vendor/vticker/jquery.vticker.min.js')}}"></script> -->
    <script src="{{ asset('situs/assets/zia_togel/desktop/assets/js/vendor/jflickrfeed/jflickrfeed.min.js')}}"></script>
    <script src="{{ asset('situs/assets/zia_togel/desktop/assets/js/vendor/appear/jquery.appear.js')}}"></script>
    <script src="{{ asset('situs/assets/zia_togel/desktop/assets/js/vendor/parallax/jquery.parallax-1.1.3.js')}}"></script>
    <script src="{{ asset('situs/assets/zia_togel/desktop/assets/js/vendor/liScroller/jquery.li-scroller.1.0.js')}}"></script>
    <script src="{{ asset('situs/assets/zia_togel/desktop/assets/js/jquery.cycle2.min.js')}}"></script>
    <script src="{{ asset('situs/assets/zia_togel/desktop/assets/js/jquery.fixedheadertable.min.js')}}"></script>
    <script src="{{ asset('situs/assets/zia_togel/desktop/assets/js/stylec619.js?v=1.0')}}"></script>
    <script>
        (function($) {
            "use strict";
