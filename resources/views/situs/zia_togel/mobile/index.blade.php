<!DOCTYPE html>
<!-- saved from url=(0026)https://indratogel176.com/m/ -->
<html lang="en">
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <title>Zia Togel adalah Situs Bandar Togel Online Resmi Terpercaya</title>
    ...
    <link
      rel="icon"
      type="image/png"
      href="https://indratogel176.com/assets/img/auo/favicon.png') }}"
    />
    <link
      rel="shortcut icon"
      type="image/png"
    ...
    <link
      href="{{ asset('situs/assets/indra_togel/mobile/style.css') }}"
      rel="stylesheet"
      type="text/css"
    />
    <link
      href="{{ asset('situs/assets/indra_togel/mobile/style(1).css') }}"
      rel="stylesheet"
      type="text/css"
    />
    <style type="text/css">
    ...
    <div class="all-elements">
      <div id="content" class="page-content" data-snap-ignore="true">
        <div class="page-header smartb1">
          ...
          <a class="smartb2" href="https://indratogel176.com/m/index.php"
            ><img
              class="header-logo2"
              src="{{ asset('situs/assets/indra_togel/mobile/logo.png') }}"
              width="130"
          /></a>
          <div class="buttonlc space smartb3">
            <a
              href="https://direct.lc.chat/13772640/"
              class="buttonWrap buttonlc2 button-orange"
              _blank=""
              >Live Chat</a
            >
          </div>
        ...
        <div class="content smartb4">
          <div class="container main no-bottom">
            ...
            <div class="wrapper2">
              ...
              <div>
                <script
                  type="text/javascript"
                  src="{{ asset('situs/assets/indra_togel/mobile/vbulletin_md5.js.download') }}"
                ></script>
                <form
                  action="https://indratogel176.com/m/index.php"
                  method="post"
                ...
                >
                  <div class="form-group">
                    <input
                      ...
                      name="entered_login"
                      tabindex="1"
                      class="contactField requiredField center"
                      type="text"
                      value=""
                  ...
                  <div class="form-group">
                    <span class="showp" onclick="showpassword()">
                        <img src="{{ asset('situs/assets/indra_togel/mobile/eye.png') }}" />
                  ...
                  <div>
                    <a
                      href="https://indratogel176.com/m/forget-password.php"
                      class="note right underline"
                      >Lupa password?</a
                    >

                    <a
                      href="https://indratogel176.com/lite/index.php"
                      class="note left underline"
                      >Lite Mode</a
                    >
                ...
                <div class="buttonjoin">
                  <a
                    href="https://indratogel176.com/m/register.php"
                    class="buttonWrap buttong button-green contactSubmitButton"
                    >Daftar</a
                  >
                </div>
              </div>
            ...
            <style>
                #loadingCustom {
                    ...
                    bottom: 0;
                    z-index: 999999;
                    background-image: url('/situs/assets/indra_togel/zia-loading-mobile.gif');
                ...
                @media (min-width: 576px) {
                    /* yg besar diisni */
                    #loadingCustom {
                        background-image: url("/situs/assets/indra_togel/zia-loading.gif") !important;
                    }
                }
            </style>
            ...
            <div class="inner-wrap">
              <div class="panel-blue">
                ...
                <div style="display: flex; float: right">
                  ...
                  >
                  <a
                    id="slider-hasil-left"
                    href="javascript:void(0);"
                    class="btn prev prevControl"
                    ><i
                      style="
                        border: 2px solid;
                        border-radius: 50%;
                  ...
                  ></a>
                  <a
                    id="slider-hasil-right"
                    href="javascript:void(0);"
                    class="btn next nextControl"
                    ><i
                      style="
                        border: 2px solid;
                        border-radius: 50%;
                ...
                <div id="slider-hasil">
                  <div class="slider">
                    <div class="results">
                      ...
                      <div class="pool-result">4134</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">FLORIDA MID</div>
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">7113</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">NEW YORK MID</div>
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">5806</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">OREGON03</div>
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">4217</div>
                    </div>
                  </div>
                  <div class="slider">
                    <div class="results">
                      ...
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">5002</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">CALIFORNIA</div>
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">2561</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">FLORIDA EVE</div>
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">6980</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">OREGON09</div>
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">6874</div>
                    </div>
                  </div>
                  <div class="slider">
                    <div class="results">
                      ...
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">8168</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">KENTUCKY EVE</div>
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">5164</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">CAROLINA EVE</div>
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">9230</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">CAMBODIA</div>
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">7825</div>
                    </div>
                  </div>
                  <div class="slider">
                    <div class="results">
                      ...
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">9345</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">BULLSEYE</div>
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">3000</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">SYDNEY</div>
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">4674</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">CHINA</div>
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">2652</div>
                    </div>
                  </div>
                  <div class="slider">
                    <div class="results">
                      ...
                      <div class="pool-result">4369</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">SINGAPORE</div>
                      <div class="pool-date">2022-10-02</div>
                      <div class="pool-result">1559</div>
                    </div>
                    ...
                    <div class="results">
                      ...
                      <div class="pool-date">2022-10-01</div>
                      <div class="pool-result">2245</div>
                    </div>
                  </div>
                  <div class="slider">
                    <div class="results">
                      ...
                      <div class="pool-date">2022-10-02</div>
                      <div class="pool-result">9695</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">NEVADA</div>
                      <div class="pool-date">2022-10-02</div>
                      <div class="pool-result">3007</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">HONGKONG</div>
                      <div class="pool-date">2022-10-02</div>
                      <div class="pool-result">8317</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">CAROLINADAY</div>
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">8613</div>
                    </div>
                  </div>
                  <div class="slider">
                    <div class="results">
                      ...
                      <div class="pool-date">2022-10-02</div>
                      <div class="pool-result">4992</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">POIPET19</div>
                      <div class="pool-date">2022-10-02</div>
                      <div class="pool-result">5419</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">POIPET15</div>
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">5300</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">POIPET12</div>
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">1257</div>
                    </div>
                  </div>
                  <div class="slider">
                    <div class="results">
                      ...
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">8840</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">BRUNEI 21</div>
                      <div class="pool-date">2022-10-02</div>
                      <div class="pool-result">9503</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">BRUNEI 02</div>
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">4971</div>
                    </div>
                  ...
                  <div class="slider">
                    <div class="results">
                      ...
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">5000</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">CHELSEA 19</div>
                      <div class="pool-date">2022-10-02</div>
                      <div class="pool-result">2499</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">CHELSEA 21</div>
                      <div class="pool-date">2022-10-02</div>
                      <div class="pool-result">6885</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">HUAHIN 0100</div>
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">1960</div>
                    </div>
                  </div>
                  <div class="slider">
                    <div class="results">
                      ...
                      <div class="pool-date">2022-10-02</div>
                      <div class="pool-result">2351</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">HUAHIN 2100</div>
                      <div class="pool-date">2022-10-02</div>
                      <div class="pool-result">4743</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">BANGKOK 0930</div>
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">5930</div>
                    </div>

                    <div class="results">
                      <div class="pool-name">BANGKOK 0130</div>
                      <div class="pool-date">2022-10-03</div>
                      <div class="pool-result">7562</div>
                    </div>
                  </div>
                  <div class="slider">
                    <div class="results">
                      ...
                      <div class="pool-result">
                        <img src="{{ asset('situs/assets/indra_togel/mobile/13.png') }}" width="22px" />
                      </div>
                    </div>
                    <div class="results">
                      ...
                      <div class="pool-result">
                        <img
                          src="{{ asset('situs/assets/indra_togel/mobile/dice5.png') }}"
                  ...
                  <div class="slider">
                    <div class="results">
                      ...
                      <div class="pool-date"></div>
                      <div class="pool-result">
                        <img src="{{ asset('situs/assets/indra_togel/mobile/03.png') }}" width="22px" />
                      </div>
                    </div>
                    <div class="results">
                      ...
                      <div class="pool-result">
                        <img
                          ...
                          src="{{ asset('situs/assets/indra_togel/mobile/dice1.png') }}"
                        /><img
                          style="width: 20px; margin: 6px 1px"
                          src="{{ asset('situs/assets/indra_togel/mobile/dice3.png') }}"
                        /><img
                          style="width: 20px; margin: 6px 1px"
                          src="{{ asset('situs/assets/indra_togel/mobile/dice6.png') }}"
                        />
                      </div>
                    </div>
                  </div>
          ...
          <div class="row" style="display: flex">
            <div class="col-6 col-sm-6">
              <img
                src="{{ asset('situs/assets/indra_togel/mobile/idnplay_w.png') }}"
                style="
            ...
            <div class="col-6 col-sm-6">
              <img
                src="{{ asset('situs/assets/indra_togel/mobile/pagcorlogo2.png') }}"
          ...
          <div class="footer">
            <div class="wrapper">
              <div class="center-text">
                © 2014 - 2022 indratogel176. All Rights Reserved | 18+
              </div>
            </div>
          </div>
        </div>
      ...
      <script
        type="text/javascript"
        src="{{ asset('situs/assets/indra_togel/mobile/_footer.js.download') }}"
      ></script>
      <script
        src="{{ asset('situs/assets/indra_togel/mobile/moment.min.js.download') }}"
        type="text/javascript"
      ></script>
