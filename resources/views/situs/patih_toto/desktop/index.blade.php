...
<head>
    ...
    <title>PATIHTOTO | Agen Togel Online Terbesar Terpercaya</title>
    ...
    <meta name="keywords"
        content="Agen Togel Online Terbesar, Togel Online Terbesar Terpercaya,  Agen Togel Online Terpercaya, Togel Online Terbesar Terbesar" />

    <meta name="google-site-verification" content="7sv5UaDnu3Ebo4DJktZn1iz9Ls-9rZ7sfYvS9bbGhe0" />
    ...
    <script>
        ...
        gtag('config', 'G-HW1T95PB97');
    </script>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="icon" type="image/ico"
        href="{{ asset('situs/assets/patih_toto/desktop/assets/img/ajj/favicon80dd.png?v=1666377904') }}" />

    <link href="{{ asset('situs/assets/patih_toto/desktop/assets/css/vendor/bootstrap/bootstrap.min.css') }}"
        rel="stylesheet">
    <link href="{{ asset('situs/assets/patih_toto/desktop/assets/css/font-awesome.min.css') }}" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('situs/assets/patih_toto/desktop/assets/css/vendor/animate/animate.css') }}">

    <link rel="stylesheet"
        href="{{ asset('situs/assets/patih_toto/desktop/assets/css/vendor/bootstrap-checkbox.css') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/patih_toto/desktop/assets/css/vendor/ribbons/3d-corner-ribbons.css') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/patih_toto/desktop/assets/js/vendor/text-rotator/css/simpletextrotator.css') }}">
    <link rel="stylesheet" href="{{ asset('situs/assets/patih_toto/desktop/assets/css/fonts.css') }}">

    <!-- Important Owl stylesheet -->
    <link rel="stylesheet"
        href="{{ asset('situs/assets/patih_toto/desktop/assets/js/vendor/owl-carousel/css/owl.carouselca71.css?id=889') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/patih_toto/desktop/assets/js/vendor/owl-carousel/css/owl.theme.css') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/patih_toto/desktop/assets/js/vendor/owl-carousel/css/owl.transitions.css') }}">

    <link rel="stylesheet"
        href="{{ asset('situs/assets/patih_toto/desktop/assets/js/vendor/nivo-lightbox/css/nivo-lightbox.css') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/patih_toto/desktop/assets/js/vendor/nivo-lightbox/css/themes/default/default.css') }}"
        type="text/css" />
    <!-- ADDITIONAL CSS -->
    <link rel="stylesheet" href="{{ asset('situs/assets/patih_toto/desktop/assets/css/additionalffaf.css?v=1.4') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('situs/assets/patih_toto/desktop/assets/css/game_compressed_ic80dd.css?v=1666377904') }}">
    <!-- CUSTOM STYLE -->
    <link rel="stylesheet"
        href="{{ asset('situs/assets/patih_toto/desktop/assets/css/ajj/ajj280dd.css?v=1666377904') }}">
...
<body>
    ...
    <div style="position: absolute; float: right; z-index: 999999; right: 12%;top: 0;">
        <a href="#"
            onclick="window.open('https://form.6mbr.com/?webname=patihtoto176.com&amp;lang=id','kritik_saran', 'width=600, height=1000');">
            <img src="{{ asset('situs/assets/patih_toto/desktop/assets/img/feedback2.png') }}" width="115px;">
        </a>
    </div>
    <!-- BEGIN NAVBAR -->
                ...
                <div class="col-sm-9 news-body">
                    <ul id="liscroll" style="margin:0px;">
                        <li><a href="javascript:void(0);" style="margin:0px;">
                                <qwe class="run-text-depan">Selamat datang di PATIHTOTO ! Coba keberuntungan anda hanya
                                    bersama dengan
                                    kami - Bandar togel terpercaya - PATIHTOTO</qwe>
                            </a></li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="results">
                        ...
                        <div class="news-detail">
                            <div class="latest-news"><a href="javascript:void(0);"><span
                                    ...
                                    class="dates">2022-10-13 22:10:28</span>
                            </div>
                            <div class="latest-news"><a href="javascript:void(0);"><span
                                        style="color:#73c1ff"><b>Cara Pasang
                                            Togel Online Di PATIHTOTO - FAQ</b></span></a><br><span
                                    class="dates">2022-10-13 16:55:07</span>
                            </div>
                            <div class="latest-news"><a href="javascript:void(0);"><span
                                        style="color:#73c1ff"><b>Jadwal Bank
                                            Dan Maintenance - PATIHTOTO</b></span></a><br><span
                                    class="dates">2022-09-13 15:50:49</span></div>
                        </div>
                    </div>
                </div> <!-- BEGIN SLIDER -->
                <div class="col-sm-9 blog-posts">
                    <div id="slider" class="slider">
                        ...
                        <div class="owl-carousel owl-theme">
                            ...
                            <div class="item">
                                <img src="{{ asset('situs/assets/patih_toto/desktop/images/slider/patihtoto_sliderweb_tipebet.jpg') }}"
                                    width="840px" height="482" />
                            </div>
                            <div class="item">
                                <img src="{{ asset('situs/assets/patih_toto/desktop/images/slider/patihtoto_sliderweb_allbonus.jpg') }}"
                                    width="840px" height="482" />
                            </div>
                            <div class="item">
                                <img src="{{ asset('situs/assets/patih_toto/desktop/images/slider/patihtoto_sliderweb_infopenting.jpg') }}"
                                    width="840px" height="482" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="latest-results" class="margin-top-15">
                        ...
                        <div class="owl-carousel owl-theme gameicon">
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/patih_toto/desktop/assets/img/icon/icon-BULLSEYEf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/patih_toto/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/patih_toto/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'></div>
                            ...
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    ...
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/patih_toto/desktop/assets/img/icon/icon-CHINAf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/patih_toto/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    ...
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/patih_toto/desktop/assets/img/icon/icon-hongkongf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/patih_toto/desktop/assets/img/icon/icon-MAGNUM4Df9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/patih_toto/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'></div>
                            ...
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    ...
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/patih_toto/desktop/assets/img/icon/icon-SINGAPOREf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/patih_toto/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/patih_toto/desktop/assets/img/icon/icon-SYDNEYf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/patih_toto/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'></div>
                            ...
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    ...
                                    width='210px' height='210px'></div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/patih_toto/desktop/assets/img/icon/icon-24DSPINc619.jpg?v=1.0') }}">
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/patih_toto/desktop/assets/img/icon/icon-D6c619.jpg?v=1.0') }}">
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/patih_toto/desktop/assets/img/icon/icon-TMc619.jpg?v=1.0') }}">
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/patih_toto/desktop/assets/img/icon/icon-24dc619.jpg?v=1.0') }}">
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/patih_toto/desktop/assets/img/icon/icon-RLc619.jpg?v=1.0') }}">
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/patih_toto/desktop/assets/img/icon/icon-SDc619.jpg?v=1.0') }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-9">
                    ...
                    <div class="owl-carousel owl-theme bankscroll">
                        <div class="item bank" data-animation="fadeIn">
                            ...
                            <img src="{{ asset('situs/assets/patih_toto/desktop/assets/img/bca.png') }}"
                                alt="Bank Central Asia" width="78px" height="24px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online bni"></div>
                            <img src="{{ asset('situs/assets/patih_toto/desktop/assets/img/bni.png') }}"
                                alt="Bank BNI" width="80px" height="24px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online bri"></div>
                            <img src="{{ asset('situs/assets/patih_toto/desktop/assets/img/bri.png') }}"
                                alt="Bank BRI" width="85px" height="21px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="trouble cimb"></div>
                            <img src="{{ asset('situs/assets/patih_toto/desktop/assets/img/cimb-2.png') }}"
                                alt="Bank CIMB NIAGA" width=86px height=25px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online danamon"></div>
                            <img src="{{ asset('situs/assets/patih_toto/desktop/assets/img/danamon.png') }}"
                                alt="Bank DANAMON" width="85px" height="21px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online"></div>
                            <img src="{{ asset('situs/assets/patih_toto/desktop/assets/img/GoPay.png') }}"
                                alt="GOPAY" width=86px height=22px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="offline mandiri"></div>
                            <img src="{{ asset('situs/assets/patih_toto/desktop/assets/img/nofound.html') }}"
                                alt="Bank Mandiri" width="86px" height="25px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online maybank"></div>
                            <img src="{{ asset('situs/assets/patih_toto/desktop/assets/img/maybank.png') }}"
                                alt="Maybank Indonesia" width=86px height=25px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online"></div>
                            <img src="{{ asset('situs/assets/patih_toto/desktop/assets/img/ovo.png') }}"
                                alt="OVO" width=86px height=22px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online dana"></div>
                            <img src="{{ asset('situs/assets/patih_toto/desktop/assets/img/dana.png') }}"
                                alt="DANA" width="89px" height="25px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online"></div>
                            <img src="{{ asset('situs/assets/patih_toto/desktop/assets/img/linkaja.png') }}"
                                alt="LINKAJA" width=86px height=22px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online"></div>
                            <img src="{{ asset('situs/assets/patih_toto/desktop/assets/img/BSI.png') }}"
    ...
    <script src="{{ asset('situs/assets/patih_toto/desktop/assets/js/vendor/modernizr-2.6.2-respond-1.1.0.min.js') }}">
    </script>
    <script src="{{ asset('situs/assets/patih_toto/desktop/assets/js/jquery.js') }}"></script>
    <script src="{{ asset('situs/assets/patih_toto/desktop/assets/js/vendor/bootstrap/bootstrap.min.js') }}"></script>
    <script src="{{ asset('situs/assets/patih_toto/desktop/assets/js/vendor/skrollr/skrollr.min.js') }}"></script>
    <script
        src="{{ asset('situs/assets/patih_toto/desktop/assets/js/vendor/text-rotator/jquery.simple-text-rotator.js') }}">
    </script>
    <script src="{{ asset('situs/assets/patih_toto/desktop/assets/js/vendor/owl-carousel/owl.carousel.min.js') }}">
    </script>
    <script src="{{ asset('situs/assets/patih_toto/desktop/assets/js/vendor/nivo-lightbox/nivo-lightbox.min.js') }}">
    </script>
    <script src="{{ asset('situs/assets/patih_toto/desktop/assets/js/vendor/tweet-js/jquery.tweet.min.js') }}"></script>
    {{-- <!-- <script src="{{ asset('situs/assets/patih_toto/desktop/assets/js/vendor/vticker/jquery.vticker.min.js" ></') }}script> --> --}}
    <script src="{{ asset('situs/assets/patih_toto/desktop/assets/js/vendor/jflickrfeed/jflickrfeed.min.js') }}"></script>
    <script src="{{ asset('situs/assets/patih_toto/desktop/assets/js/vendor/appear/jquery.appear.js') }}"></script>
    <script src="{{ asset('situs/assets/patih_toto/desktop/assets/js/vendor/parallax/jquery.parallax-1.1.3.js') }}">
    </script>
    <script src="{{ asset('situs/assets/patih_toto/desktop/assets/js/vendor/liScroller/jquery.li-scroller.1.0.js') }}">
    </script>
    <script src="{{ asset('situs/assets/patih_toto/desktop/assets/js/jquery.cycle2.min.js') }}"></script>
    <script src="{{ asset('situs/assets/patih_toto/desktop/assets/js/jquery.fixedheadertable.min.js') }}"></script>
    <script src="{{ asset('situs/assets/patih_toto/desktop/assets/js/stylec619.js?v=1.0') }}"></script>
    <script>
        (function($) {
            "use strict";
    ...
    <script type="text/javascript" src="{{ asset('situs/assets/patih_toto/desktop/assets/idn/idn-togel-spa.js') }}">
    </script>
</body>
