...
<head>
    ...
    <link href="{{ asset('situs/assets/dingdong_togel/desktop/assets/css/vendor/bootstrap/bootstrap.min.css') }}"
        rel="stylesheet">

    <link href="{{ asset('situs/assets/dingdong_togel/desktop/assets/css/font-awesome.min.css') }}" rel="stylesheet">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/dingdong_togel/desktop/assets/css/vendor/animate/animate.css') }}">

    <link rel="stylesheet"
        href="{{ asset('situs/assets/dingdong_togel/desktop/assets/css/vendor/bootstrap-checkbox.css') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/dingdong_togel/desktop/assets/css/vendor/ribbons/3d-corner-ribbons.css') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/dingdong_togel/desktop/assets/js/vendor/text-rotator/css/simpletextrotator.css') }}">
    <link rel="stylesheet" href="{{ asset('situs/assets/dingdong_togel/desktop/assets/css/fonts.css') }}">

    <!-- Important Owl stylesheet -->
    <link rel="stylesheet"
        href="{{ asset('situs/assets/dingdong_togel/desktop/assets/js/vendor/owl-carousel/css/owl.carouselca71.css?id=889') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/dingdong_togel/desktop/assets/js/vendor/owl-carousel/css/owl.theme.css') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/dingdong_togel/desktop/assets/js/vendor/owl-carousel/css/owl.transitions.css') }}">

    <link rel="stylesheet"
        href="{{ asset('situs/assets/dingdong_togel/desktop/assets/js/vendor/nivo-lightbox/css/nivo-lightbox.css') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/dingdong_togel/desktop/assets/js/vendor/nivo-lightbox/css/themes/default/default.css') }}"
        type="text/css" />
    <!-- ADDITIONAL CSS -->
    <link rel="stylesheet"
        href="{{ asset('situs/assets/dingdong_togel/desktop/assets/css/additionalffaf.css?v=1.4') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('situs/assets/dingdong_togel/desktop/assets/css/game_compressed_icd4f8.css?v=1666351409') }}">
    <!-- CUSTOM STYLE -->
    <link rel="stylesheet"
        href="{{ asset('situs/assets/dingdong_togel/desktop/assets/css/lr/lr2d4f8.css?v=1666351409') }}">
            ...
            var e = {
                ...
                init: function() {
                    ...
                    n.async = !0, n.type = "text/javascript", n.src =
                        "/situs/assets/dingdong_togel/desktop/assets/tracking.js", t.head.appendChild(n)
                }
            };
                ...
                <div class="col-sm-9 news-body">
                    <ul id="liscroll" style="margin:0px;">
                        <li><a href="javascript:void(0);" style="margin:0px;">
                                <qwe class="run-text-depan">SELAMAT DATANG DAN SELAMAT BERGABUNG DI DINGDONGTOGEL..**
                                    BANDAR TOGEL
                                    ONLINE TERBESAR DAN TERPERCAYA...***</qwe>
                            </a></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-3 blog-sidebar">
                    ...
                    <div class="results">
                        <h4>
                            <i class="fa fa-newspaper-o"></i>&nbsp;&nbsp;Berita Terakhir
                        </h4>
                        <div class="news-detail">
                            <div class="latest-news"><a href="latest_news543b.html?id=1437">
                                    <marquee behavior="alternate"><strong>
                                            <font
                                                style="text-shadow: 0px 0px 5px rgb(255 191 0);color: #f1c305; font-size:
                        15px ">
                                                🐠 📅 JADWAL PASARAN TOGEL 📅 🐠 </font>
                                        </strong></marquee>
                                </a><br><span class="
                        dates">2022-09-24 20:43:08</span></div>
                            <div class="latest-news"><a href="latest_news5aa1.html?id=1438">
                                    <marquee behavior="alternate"><strong>
                                            <font
                                                style="text-shadow: 0px 0px 5px rgb(255 191 0);color: #f1c305; font-size:
                        15px ">
                                                ⏰ 💣 🏦 JADWAL BANK OFFLINE & MAINTENANCE ⏰ 💣 🏦</font>
                                        </strong></marquee>
                                </a><br><span class="
                        dates">2022-10-15 22:35:26</span></div>
                            <div class="latest-news"><a href="latest_newsa0a5.html?id=1439">
                                    <marquee behavior="alternate"><strong>
                                            <font
                                                style="text-shadow: 0px 0px 5px rgb(255 191 0); color: #f1c305; font-size:
                        15px ">
                                                *📢FAQ DINGDONGTOGEL📢* </font>
                                        </strong></marquee>
                                </a><br><span class=" dates">
                                    2022-09-24 20:44:18</span></div>
                            <div class="latest-news"><a href="latest_news3802.html?id=2728"></a><br><span
                    ...
                    <div id="latest-results" class="margin-top-15">
                        ...
                        <div class="owl-carousel owl-theme gameicon">
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'>
                                <img src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'>
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'>
                                <img src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/icon/icon-BULLSEYEf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'>
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'>
                                <img src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/icon/icon-SYDNEYf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'>
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'>
                                <img src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/icon/icon-SINGAPOREf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'>
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'>
                                <img src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1') }}"
                            ...
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'>
                                <img src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/icon/icon-hongkongf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'>
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'>
                                <img src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1') }}"
                            ...
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'>
                                <img src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/icon/icon-MAGNUM4Df9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'>
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'>
                                <img src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1') }}"
                            ...
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'>
                                <img src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/icon/icon-CHINAf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'>
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'>
                                <img src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1') }}"
                            ...
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'>
                                <img
                                    src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/icon/icon-24DSPINc619.jpg?v=1.0') }}">
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'>
                                <img
                                    src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/icon/icon-D6c619.jpg?v=1.0') }}">
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'>
                                <img
                                    src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/icon/icon-TMc619.jpg?v=1.0') }}">
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'>
                                <img
                                    src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/icon/icon-24dc619.jpg?v=1.0') }}">
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'>
                                <img
                                    src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/icon/icon-RLc619.jpg?v=1.0') }}">
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'>
                                <img
                                    src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/icon/icon-SDc619.jpg?v=1.0') }}">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="owl-carousel owl-theme bankscroll">
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online bca"></div><img
                                src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/bca.png') }}"
                                alt="Bank Central Asia" width="78px" height="24px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online mandiri"></div><img
                                src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/nofound.html') }}"
                                alt="Bank Mandiri" width="78px" height="24px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online bri"></div><img
                                src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/bri.png') }}"
                                alt="Bank BRI" width="85px" height="21px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online bni"></div><img
                                src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/bni.png') }}"
                                alt="Bank BNI" width="80px" height="24px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online danamon"></div><img
                                src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/danamon.png') }}"
                                alt="Bank DANAMON" width="85px" height="21px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online cimb"></div><img
                                src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/cimb-2.png') }}"
                                alt="Bank CIMB NIAGA" width=86px height=25px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online"></div><img
                                src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/ovo.png') }}"
                                alt="OVO" width=86px height=22px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online"></div><img
                                src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/GoPay.png') }}"
                                alt="GOPAY" width=86px height=22px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online dana"></div><img
                                src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/dana.png') }}"
                                alt="DANA" width="89px" height="25px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online"></div><img
                                src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/linkaja.png') }}"
                                alt="LINKAJA" width=86px height=22px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online"></div><img
                                src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/BSI.png') }}"
                                alt="BSI" width=86px height=22px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online maybank"></div><img
                                src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/maybank.png') }}"
            ...
            <div class="container">
                <div class="row">
                    <div class="row" style="display: flex;">
                        ...
                        <div class="col-3 col-sm-3">
                            <img src="{{ asset('situs/assets/dingdong_togel/desktop/assets/img/pagcorlogo2.png') }}"
                                style="overflow: inherit !important;width: 100%;padding: 10px;">
                        </div>
                        <div class="col-3 col-sm-3"></div>
                    </div>
                    <div class="col-md-12 copyright">
                        &copy; Copyright 2014 - 2022 <a href="#">dingdongtogel176.com</a>. All Rights Reserved.
                    </div>
                </div>
            </div>
        </div>
