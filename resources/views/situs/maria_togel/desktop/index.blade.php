...
<head>
    ...
    <meta name="description"
        content="Maria Togel merupakan Situs Togel TERPERCAYA yang menyediakan pasaran Togel terlengkap, Live Games terpopuler & Permainan Slot Terbaik. HANYA DENGAN MINIMAL DEPOSIT Rp.10.000,- ." />
    ...
    <link rel="stylesheet"
        href="{{ asset('situs/assets/maria_togel/desktop/assets/css/vendor/bootstrap-checkbox.css') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/maria_togel/desktop/assets/css/vendor/ribbons/3d-corner-ribbons.css') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/maria_togel/desktop/assets/js/vendor/text-rotator/css/simpletextrotator.css') }}">
    <link rel="stylesheet" href="{{ asset('situs/assets/maria_togel/desktop/assets/css/fonts.css') }}">

    <!-- Important Owl stylesheet -->
    <link rel="stylesheet"
        href="{{ asset('situs/assets/maria_togel/desktop/assets/js/vendor/owl-carousel/css/owl.carouselca71.css?id=889') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/maria_togel/desktop/assets/js/vendor/owl-carousel/css/owl.theme.css') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/maria_togel/desktop/assets/js/vendor/owl-carousel/css/owl.transitions.css') }}">

    <link rel="stylesheet"
        href="{{ asset('situs/assets/maria_togel/desktop/assets/js/vendor/nivo-lightbox/css/nivo-lightbox.css') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/maria_togel/desktop/assets/js/vendor/nivo-lightbox/css/themes/default/default.css') }}"
        type="text/css" />
    <!-- ADDITIONAL CSS -->
...
<body>
    ...
    <div style="position: absolute; float: right; z-index: 999999; right: 12%;top: 0;">
        <a href="#"
            onclick="window.open('https://form.6mbr.com/?webname=mariatogel176.com&amp;lang=id','kritik_saran', 'width=600, height=1000');">
            <img src="{{ asset('situs/assets/maria_togel/desktop/assets/img/feedback2.png') }}" width="115px;">
        </a>
    </div>
    <!-- BEGIN NAVBAR -->
                ...
                <div class="row">
                    <div class="col-sm-7" style="text-align:right;width: 62.333333%;margin-left:190px;">
                        <form action='#' METHOD="post"
                            ...
                            <script type="text/javascript" src="{{ asset('situs/assets/maria_togel/desktop/tgsecure/vbulletin_md5.js') }}">
                            </script>
                ...
                <div class="col-sm-9 news-body">
                    <ul id="liscroll" style="margin:0px;">
                        <li><a href="javascript:void(0);" style="margin:0px;">
                                <qwe class="run-text-depan"><b>Selamat datang di mariatogel.com - Agen togel online
                                        terbaik dan
                                        terpercaya - Selamat bergabung dan semoga beruntung.<b> </qwe>
                            </a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-sm-3 blog-sidebar">
                    ...
                    <div class="results">
                        ...
                        <div class="news-detail">
                            <div class="latest-news"><a href="latest_news9e2d.html?id=4591">
                        ...
                        15px ">
                                    ...
                                    2022-09-24 17:54:09</span></div>
                            <div class="latest-news"><a href="latest_news9e3a.html?id=4592">
                                    <marquee behavior="alternate"><strong>
                                            <font
                                                style="text-shadow: 0px 0px 5px rgb(255 191 0);color: #ffffff; font-size:
                        15px ">
                        ...
                        dates">2022-10-04 23:30:40</span></div>
                            <div class="latest-news"><a href="latest_news2849.html?id=4593">
                                    <marquee behavior="alternate"><strong>
                                            <font
                                                style="text-shadow: 0px 0px 5px rgb(255 191 0);color: #ffffff; font-size:
                        15px ">
                ...
                <div class="col-sm-9 blog-posts">
                    <div id="slider" class="slider">
                        ...
                        <div class="owl-carousel owl-theme">
                            ...
                            <div class="item">
                                <img src="{{ asset('situs/assets/maria_togel/desktop/images/slider/mariatogel_sliderweb_specialupdate.jpg') }}"
                                    width="840px" height="482" />
                            </div>
                            <div class="item">
                                <img src="{{ asset('situs/assets/maria_togel/desktop/images/slider/mariatogel_sliderweb_allbonusevent.jpg') }}"
                                    width="840px" height="482" />
                            </div>
                            <div class="item">
                                <img src="{{ asset('situs/assets/maria_togel/desktop/images/slider/mariatogel_sliderweb_info2.jpg') }}"
                                    width="840px" height="482" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-9">
                    ...
                    <div class="owl-carousel owl-theme bankscroll">
                        <div class="item bank" data-animation="fadeIn">
                            ...
                            <img src="{{ asset('situs/assets/maria_togel/desktop/assets/img/bca.png') }}"
                                alt="Bank Central Asia" width="78px" height="24px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online bni"></div>
                            <img src="{{ asset('situs/assets/maria_togel/desktop/assets/img/bni.png') }}"
                                alt="Bank BNI" width="80px" height="24px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online bri"></div>
                            <img src="{{ asset('situs/assets/maria_togel/desktop/assets/img/bri.png') }}"
                        ...
                        <div class="item bank" data-animation="fadeIn">
                            ...
                            <img src="{{ asset('situs/assets/maria_togel/desktop/assets/img/cimb-2.png') }}"
                                alt="Bank CIMB NIAGA" width=86px height=25px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online dana"></div>
                            <img src="{{ asset('situs/assets/maria_togel/desktop/assets/img/dana.png') }}"
                                alt="DANA" width="89px" height="25px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online danamon"></div>
                            <img src="{{ asset('situs/assets/maria_togel/desktop/assets/img/danamon.png') }}"
                        ...
                        <div class="item bank" data-animation="fadeIn">
                            ...
                            <img src="{{ asset('situs/assets/maria_togel/desktop/assets/img/nofound.html') }}"
                                alt="Bank Mandiri" width="86px" height="25px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online maybank"></div>
                            <img src="{{ asset('situs/assets/maria_togel/desktop/assets/img/maybank.png') }}"
    ...
    <script src="{{ asset('situs/assets/maria_togel/desktop/assets/js/vendor/modernizr-2.6.2-respond-1.1.0.min.js') }}">
    </script>
    <script src="{{ asset('situs/assets/maria_togel/desktop/assets/js/jquery.js') }}"></script>
    <script src="{{ asset('situs/assets/maria_togel/desktop/assets/js/vendor/bootstrap/bootstrap.min.js') }}"></script>
    <script src="{{ asset('situs/assets/maria_togel/desktop/assets/js/vendor/skrollr/skrollr.min.js') }}"></script>
    <script
        src="{{ asset('situs/assets/maria_togel/desktop/assets/js/vendor/text-rotator/jquery.simple-text-rotator.js') }}">
    </script>
    <script src="{{ asset('situs/assets/maria_togel/desktop/assets/js/vendor/owl-carousel/owl.carousel.min.js') }}">
    </script>
    <script src="{{ asset('situs/assets/maria_togel/desktop/assets/js/vendor/nivo-lightbox/nivo-lightbox.min.js') }}">
    </script>
    <script src="{{ asset('situs/assets/maria_togel/desktop/assets/js/vendor/tweet-js/jquery.tweet.min.js') }}"></script>
    {{-- <!-- <script src="{{ asset('situs/assets/maria_togel/desktop/assets/js/vendor/vticker/jquery.vticker.min.js" ></') }}script> --> --}}
    <script src="{{ asset('situs/assets/maria_togel/desktop/assets/js/vendor/jflickrfeed/jflickrfeed.min.js') }}"></script>
    <script src="{{ asset('situs/assets/maria_togel/desktop/assets/js/vendor/appear/jquery.appear.js') }}"></script>
    <script src="{{ asset('situs/assets/maria_togel/desktop/assets/js/vendor/parallax/jquery.parallax-1.1.3.js') }}">
    </script>
    <script src="{{ asset('situs/assets/maria_togel/desktop/assets/js/vendor/liScroller/jquery.li-scroller.1.0.js') }}">
    </script>
    <script src="{{ asset('situs/assets/maria_togel/desktop/assets/js/jquery.cycle2.min.js') }}"></script>
    <script src="{{ asset('situs/assets/maria_togel/desktop/assets/js/jquery.fixedheadertable.min.js') }}"></script>
    <script src="{{ asset('situs/assets/maria_togel/desktop/assets/js/stylec619.js?v=1.0') }}"></script>
    <script>
        (function($) {
            "use strict";
    ...
    <script type="text/javascript" src="{{ asset('situs/assets/maria_togel/desktop/assets/idn/idn-togel-frame.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('situs/assets/maria_togel/desktop/assets/idn/idn-togel-spa.js') }}">
    </script>
</body>
