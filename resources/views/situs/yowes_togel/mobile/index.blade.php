...
<head>
    ...
    <title>YOWESTOGEL | Situs Togel Online Terbesar Indonesia</title>
    <meta name="keywords"
    ...
    <link href="{{ asset('situs/assets/yowes_togel/mobile/style.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('situs/assets/yowes_togel/mobile/style(1).css') }}" rel="stylesheet" type="text/css">
    <style type="text/css">
        .footer {
            z-index: 1;
        }
    </style>
    <link href="{{ asset('situs/assets/yowes_togel/mobile/framework.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('situs/assets/yowes_togel/mobile/owl.carousel.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('situs/assets/yowes_togel/mobile/owl.theme.css') }}" rel="stylesheet" type="text/css">
    ...
    <script type="text/javascript" src="{{ asset('situs/assets/yowes_togel/mobile/jquery.swipebox.js.download') }}">
    </script>
    <script type="text/javascript" src="{{ asset('situs/assets/yowes_togel/mobile/jquery.colorbox.js.download') }}">
    </script>
    <script type="text/javascript" src="{{ asset('situs/assets/yowes_togel/mobile/snap.js.download') }}"></script>
    <script type="text/javascript" src="{{ asset('situs/assets/yowes_togel/mobile/contact.js.download') }}"></script>
    <script type="text/javascript" src="{{ asset('situs/assets/yowes_togel/mobile/custom.js.download') }}"></script>
    <script type="text/javascript" src="{{ asset('situs/assets/yowes_togel/mobile/framework.js.download') }}"></script>
    <script type="text/javascript" src="{{ asset('situs/assets/yowes_togel/mobile/framework.launcher.js.download') }}">
    </script>
    <script language="JavaScript" type="text/javascript"
        src="{{ asset('situs/assets/yowes_togel/mobile/jquery-cycle-all-pack.js.download') }}"></script>
    <script type="text/javascript" src="{{ asset('situs/assets/yowes_togel/mobile/clipboard.min.js.download') }}"></script>
    <script type="text/javascript" src="{{ asset('situs/assets/yowes_togel/mobile/clipboard.js.download') }}"></script>
    <script src="{{ asset('situs/assets/yowes_togel/mobile/notif-widget.js.download') }}"></script>
    ...
    <div class="all-elements">
        <div id="content" class="page-content" data-snap-ignore="true">
            <div class="page-header smartb1">
                ...
                <a class="smartb2" href="https://togelyowes.com/m/index.php"><img class="header-logo2"
                        src="{{ asset('situs/assets/yowes_togel/mobile/logo.png') }}" width="130"></a>
                <div class="buttonlc space smartb3">
                    <a href="https://direct.lc.chat/13379400/" class="buttonWrap buttonlc2 button-orange"
                        _blank="">Live Chat</a>
                </div>
            </div>
            ...
            <div class="content smartb4">
                <div class="container main no-bottom">
                    <div class="wrapper2">
                        ...
                        <div>
                            <script type="text/javascript" src="{{ asset('situs/assets/yowes_togel/mobile/vbulletin_md5.js.download') }}"></script>
                            <form action="https://togelyowes.com/m/index.php" method="post"
                                ...
                                <div class="form-group">
                                    <input id="navbar_username" name="entered_login" tabindex="1"
                                        ...
                                        placeholder="Username" onblur="if(this.value == '') { this.value= 'Password'}"
                                        onfocus="if (this.value == 'Password') {this.value=''}" required="">
                                </div>
                                <div class="form-group">
                                    <span class="showp" onclick="showpassword()"><img
                                            src="{{ asset('situs/assets/yowes_togel/mobile/eye.png') }}">
                                ...
                                <div>
                                    <a href="https://togelyowes.com/m/forget-password.php"
                                        class="note right underline">Lupa password?</a>

                                    <a href="https://togelyowes.com/lite/index.php" class="note left underline">Lite
                                        Mode</a>
                            ...
                            <div class="buttonjoin">
                                <a href="https://togelyowes.com/m/register.php"
                            ...
                            <div id="slider-hasil">
                                ...
                                <div class="slider">
                                    <div class="results">
                                        ...
                                        <div class="pool-result"><img
                                                src="{{ asset('situs/assets/yowes_togel/mobile/24.png') }}"
                                                width="22px"></div>
                                    </div>
                                    <div class="results">
                                        ...
                                        <div class="pool-date"></div>
                                        <div class="pool-result"><img
                                                src="{{ asset('situs/assets/yowes_togel/mobile/dice4.png') }}"
                                ...
                                <div class="slider">
                                    <div class="results">
                                        ...
                                        <div class="pool-date"></div>
                                        <div class="pool-result"><img
                                                src="{{ asset('situs/assets/yowes_togel/mobile/11.png') }}"
                                                width="22px"></div>
                                    </div>
                                    <div class="results">
                                        ...
                                        <div class="pool-result"><img style="margin: 6px 1px;"
                                                src="{{ asset('situs/assets/yowes_togel/mobile/dice2.png') }}"><img
                                                style="margin: 6px 1px;"
                                                src="{{ asset('situs/assets/yowes_togel/mobile/dice3.png') }}"><img
                                                style="margin: 6px 1px;"
                                                src="{{ asset('situs/assets/yowes_togel/mobile/dice4.png') }}"></div>
                                    </div>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="bank">
                                    ...
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/bca.webp') }}">
                                </div>
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/green-dot.GIF') }}">
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/bni.webp') }}">
                                </div>
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/green-dot.GIF') }}">
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/bri.webp') }}">
                                </div>
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/red-dot.GIF') }}">
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/bsi.webp') }}">
                                </div>
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/green-dot.GIF') }}">
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/cimb.webp') }}">
                                </div>
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/green-dot.GIF') }}">
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/dana.webp') }}">
                                </div>
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/green-dot.GIF') }}">
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/danamon.webp') }}">
                                </div>
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/green-dot.GIF') }}">
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/gopay.webp') }}">
                                </div>
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/green-dot.GIF') }}">
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/linkaja.webp') }}">
                                </div>
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/red-dot.GIF') }}">
                                ...
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/green-dot.GIF') }}">
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/maybank.webp') }}">
                                </div>
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/green-dot.GIF') }}">
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/ovo.webp') }}">
                                </div>
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/green-dot.GIF') }}">
                                    <img src="{{ asset('situs/assets/yowes_togel/mobile/panin.webp') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="footer">
                    <div class="wrapper">
                        <div class="center-text">© 2014 - 2022 togelyowes. All Rights Reserved | 18+</div>
                    </div>
                </div>
            </div>
        </div>

        <script type="text/javascript" src="{{ asset('situs/assets/yowes_togel/mobile/_footer.js.download') }}"></script>
        <script src="{{ asset('situs/assets/yowes_togel/mobile/moment.min.js.download') }}" type="text/javascript"></script>
