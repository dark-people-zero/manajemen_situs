...
<head>
    ...
    <title>PROTOGEL.COM | Bandar Togel Online Resmi Terpercaya</title>
    <meta name="keywords"
        content="Bandar Togel Online Resmi, Togel Online Resmi Terpercaya, Bandar Togel Online Terpercaya, Bandar Togel Resmi Terpercaya" />
    <meta name="description"
        content="PROTOGEL.COM adalah bandar togel online resmi terpercaya yang menyediakan permainan togel yang diundi secara online dari togel Hongkong, Singapura, Sydney, Toto Macau, Nevada, Cambodia, China, Taiwan. Protogel juga menyediakan banyak jenis permainan Live Casino Online paling menantang seperti Roulette, Sicbo, Baccarat, 12D, 24D dan masih banyak lagi. Tersedia berbagai jenis bettingan dengan diskon dan hadiah terbesar untuk anda. Cara bermain yang mudah dengan banyak pilihan jenis bettingan membuat anda nyaman bermain di protogel. Sistem Deposit dan Withdraw tercepat yang didukung oleh customer server online yang siap melayani semua kendala anda selama 24 jam penuh." />
    <meta name="google-site-verification" content="5Yu-MI97qp2t5el2RIPrx1LAdyJoL0_QvKHQ8i7j9h4" />
    <style type="text/css">
        .breadcrumbs {
    ...
    <link rel="icon" type="image/ico"
        href="{{ asset('situs/assets/pro_togel/desktop/assets/img/alg/favicone752.png?v=1666377905') }}" />

    <link href="{{ asset('situs/assets/pro_togel/desktop/assets/css/vendor/bootstrap/bootstrap.min.css') }}"
        rel="stylesheet">
    <link href="{{ asset('situs/assets/pro_togel/desktop/assets/css/font-awesome.min.css') }}" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('situs/assets/pro_togel/desktop/assets/css/vendor/animate/animate.css') }}">

    <link rel="stylesheet"
        href="{{ asset('situs/assets/pro_togel/desktop/assets/css/vendor/bootstrap-checkbox.css') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/pro_togel/desktop/assets/css/vendor/ribbons/3d-corner-ribbons.css') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/pro_togel/desktop/assets/js/vendor/text-rotator/css/simpletextrotator.css') }}">
    <link rel="stylesheet" href="{{ asset('situs/assets/pro_togel/desktop/assets/css/fonts.css') }}">

    <!-- Important Owl stylesheet -->
    <link rel="stylesheet"
        href="{{ asset('situs/assets/pro_togel/desktop/assets/js/vendor/owl-carousel/css/owl.carouselca71.css?id=889') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/pro_togel/desktop/assets/js/vendor/owl-carousel/css/owl.theme.css') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/pro_togel/desktop/assets/js/vendor/owl-carousel/css/owl.transitions.css') }}">

    <link rel="stylesheet"
        href="{{ asset('situs/assets/pro_togel/desktop/assets/js/vendor/nivo-lightbox/css/nivo-lightbox.css') }}">
    <link rel="stylesheet"
        href="{{ asset('situs/assets/pro_togel/desktop/assets/js/vendor/nivo-lightbox/css/themes/default/default.css') }}"
        type="text/css" />
    <!-- ADDITIONAL CSS -->
    <link rel="stylesheet" href="{{ asset('situs/assets/pro_togel/desktop/assets/css/additionalffaf.css?v=1.4') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('situs/assets/pro_togel/desktop/assets/css/game_compressed_ice752.css?v=1666377905') }}">
    <!-- CUSTOM STYLE -->
    <link rel="stylesheet"
        href="{{ asset('situs/assets/pro_togel/desktop/assets/css/alg/alg2e752.css?v=1666377905') }}">
...
<body>
    ...
    <noscript><a href="https://www.livechatinc.com/chat-with/13378836/" rel="nofollow">Chat with us</a>, powered by <a
    ...
    <div style="position: absolute; float: right; z-index: 999999; right: 12%;top: 0;">
        <a href="#"
            onclick="window.open('https://form.6mbr.com/?webname=protgl.com&amp;lang=id','kritik_saran', 'width=600, height=1000');">
            <img src="{{ asset('situs/assets/pro_togel/desktop/assets/img/feedback2.png') }}" width="115px;">
        </a>
    </div>
    <!-- BEGIN NAVBAR -->
                ...
                <div class="row">
                    <div class="col-sm-7" style="text-align:right;width: 62.333333%;margin-left:190px;">
                        <form action='#' METHOD="post"
                            ...
                            <script type="text/javascript" src="{{ asset('situs/assets/pro_togel/desktop/tgsecure/vbulletin_md5.js') }}"></script>
                ...
                <div class="col-sm-3 blog-sidebar">
                    ...
                    <div class="results">
                        ...
                        <div class="news-detail">
                            <div class="latest-news"><a href="javascript:void(0);"><span style="color:#ffb400">HASIL
                                        KELUARAN
                                        TOGEL</span></a><br><span class="dates">2022-09-24 15:44:41</span></div>
                            <div class="latest-news"><a href="javascript:void(0);"><span style="color:#ffb400">JADWAL
                                        BANK
                                        DAN MAINTENANCE</span></a><br><span class="dates">2022-10-17 23:55:17</span>
                            </div>
                            <div class="latest-news"><a href="javascript:void(0);"><span style="color:#ffb400">JADWAL
                                        PASARAN
                                        TOGEL</span></a><br><span class="dates">2022-09-24 15:25:04</span></div>
                        </div>
                    </div>
                </div> <!-- BEGIN SLIDER -->
                <div class="col-sm-9 blog-posts">
                    <div id="slider" class="slider">
                        ...
                        <div class="owl-carousel owl-theme">
                            ...
                            <div class="item">
                                <img src="{{ asset('situs/assets/pro_togel/desktop/images/slider/protogel_sliderweb_allbonus2.jpg') }}"
                                    width="840px" height="482" />
                            </div>
                            <div class="item">
                                <img src="{{ asset('situs/assets/pro_togel/desktop/images/slider/protogel_sliderweb_tipepasaran.jpg') }}"
                                    width="840px" height="482" />
                            </div>
                            <div class="item">
                                <img src="{{ asset('situs/assets/pro_togel/desktop/images/slider/protogel_sliderweb_bonusmasuk.jpg') }}"
                                    width="840px" height="482" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="latest-results" class="margin-top-15">
                        ...
                        <div class="owl-carousel owl-theme gameicon">
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/pro_togel/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1') }}"
                            ...
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/pro_togel/desktop/assets/img/icon/icon-SINGAPOREf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'>
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/pro_togel/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1') }}"
                            ...
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/pro_togel/desktop/assets/img/icon/icon-MAGNUM4Df9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'>
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/pro_togel/desktop/assets/img/icon/icon-hongkongf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'>
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/pro_togel/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1') }}"
                            ...
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/pro_togel/desktop/assets/img/icon/icon-SYDNEYf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'>
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/pro_togel/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1') }}"
                            ...
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/pro_togel/desktop/assets/img/icon/icon-BULLSEYEf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'>
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/pro_togel/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1') }}"
                            ...
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/pro_togel/desktop/assets/img/icon/icon-CHINAf9e3.jpg?v=1.1') }}"
                                    width='210px' height='210px'>
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/pro_togel/desktop/assets/img/icon/icon-poolsf9e3.jpg?v=1.1') }}"
                            ...
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/pro_togel/desktop/assets/img/icon/icon-24DSPINc619.jpg?v=1.0') }}">
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                                    src="{{ asset('situs/assets/pro_togel/desktop/assets/img/icon/icon-D6c619.jpg?v=1.0') }}">
                            </div>
                            <div class="item slides" data-animation="fadeIn" style='text-align:center'><img
                ...
                <div class="col-md-9">
                    ...
                    <div class="owl-carousel owl-theme bankscroll">
                        <div class="item bank" data-animation="fadeIn">
                            ...
                            <img src="{{ asset('situs/assets/pro_togel/desktop/assets/img/bca.png') }}"
                                alt="Bank Central Asia" width="78px" height="24px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online bni"></div>
                            <img src="{{ asset('situs/assets/pro_togel/desktop/assets/img/bni.png') }}"
                                alt="Bank BNI" width="80px" height="24px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="trouble bri"></div>
                            <img src="{{ asset('situs/assets/pro_togel/desktop/assets/img/bri.png') }}"
                                alt="Bank BRI" width="85px" height="21px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online"></div>
                            <img src="{{ asset('situs/assets/pro_togel/desktop/assets/img/BSI.png') }}"
                                alt="BSI" width=86px height=22px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="trouble cimb"></div>
                            <img src="{{ asset('situs/assets/pro_togel/desktop/assets/img/cimb-2.png') }}"
                                alt="Bank CIMB NIAGA" width=86px height=25px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online dana"></div>
                            <img src="{{ asset('situs/assets/pro_togel/desktop/assets/img/dana.png') }}"
                                alt="DANA" width="89px" height="25px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online danamon"></div>
                            <img src="{{ asset('situs/assets/pro_togel/desktop/assets/img/danamon.png') }}"
                                alt="Bank DANAMON" width="85px" height="21px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online"></div>
                            <img src="{{ asset('situs/assets/pro_togel/desktop/assets/img/GoPay.png') }}"
                                alt="GOPAY" width=86px height=22px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online"></div>
                            <img src="{{ asset('situs/assets/pro_togel/desktop/assets/img/linkaja.png') }}"
                                alt="LINKAJA" width=86px height=22px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="offline mandiri"></div>
                            <img src="{{ asset('situs/assets/pro_togel/desktop/assets/img/nofound.html') }}"
                                alt="Bank Mandiri" width="86px" height="25px">
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online maybank"></div>
                            <img src="{{ asset('situs/assets/pro_togel/desktop/assets/img/maybank.png') }}"
                                alt="Maybank Indonesia" width=86px height=25px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online"></div>
                            <img src="{{ asset('situs/assets/pro_togel/desktop/assets/img/ovo.png') }}"
                                alt="OVO" width=86px height=22px>
                        </div>
                        <div class="item bank" data-animation="fadeIn">
                            <div class="online panin"></div>
                            <img src="{{ asset('situs/assets/pro_togel/desktop/assets/img/panin.png') }}"
    ...
    <script src="{{ asset('situs/assets/pro_togel/desktop/assets/js/vendor/modernizr-2.6.2-respond-1.1.0.min.js') }}">
    </script>
    <script src="{{ asset('situs/assets/pro_togel/desktop/assets/js/jquery.js') }}"></script>
    <script src="{{ asset('situs/assets/pro_togel/desktop/assets/js/vendor/bootstrap/bootstrap.min.js') }}"></script>
    <script src="{{ asset('situs/assets/pro_togel/desktop/assets/js/vendor/skrollr/skrollr.min.js') }}"></script>
    <script
        src="{{ asset('situs/assets/pro_togel/desktop/assets/js/vendor/text-rotator/jquery.simple-text-rotator.js') }}">
    </script>
    <script src="{{ asset('situs/assets/pro_togel/desktop/assets/js/vendor/owl-carousel/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('situs/assets/pro_togel/desktop/assets/js/vendor/nivo-lightbox/nivo-lightbox.min.js') }}">
    </script>
    <script src="{{ asset('situs/assets/pro_togel/desktop/assets/js/vendor/tweet-js/jquery.tweet.min.js') }}"></script>
    {{-- <!-- <script src="{{ asset('situs/assets/pro_togel/desktop/assets/js/vendor/vticker/jquery.vticker.min.js"></') }}script> --> --}}
    <script src="{{ asset('situs/assets/pro_togel/desktop/assets/js/vendor/jflickrfeed/jflickrfeed.min.js') }}"></script>
    <script src="{{ asset('situs/assets/pro_togel/desktop/assets/js/vendor/appear/jquery.appear.js') }}"></script>
    <script src="{{ asset('situs/assets/pro_togel/desktop/assets/js/vendor/parallax/jquery.parallax-1.1.3.js') }}">
    </script>
    <script src="{{ asset('situs/assets/pro_togel/desktop/assets/js/vendor/liScroller/jquery.li-scroller.1.0.js') }}">
    </script>
    <script src="{{ asset('situs/assets/pro_togel/desktop/assets/js/jquery.cycle2.min.js') }}"></script>
    <script src="{{ asset('situs/assets/pro_togel/desktop/assets/js/jquery.fixedheadertable.min.js') }}"></script>
    <script src="{{ asset('situs/assets/pro_togel/desktop/assets/js/stylec619.js?v=1.0') }}"></script>
    <script>
        (function($) {
            "use strict";
    ...
    <script type="text/javascript" src="{{ asset('situs/assets/pro_togel/desktop/assets/idn/idn-togel-frame.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('situs/assets/pro_togel/desktop/assets/idn/idn-togel-spa.js') }}">
    </script>
</body>
