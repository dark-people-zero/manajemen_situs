...
<meta name="keywords" content="Bandar Togel Online Terpercaya, Bandar Togel Online Resmi, Bandar Togel Terpercaya, Togel Online Resmi Terpercaya"/>
<meta name="description" content="INDRATOGEL adalah situs bandar togel online terpercaya yang menyediakan permainan togel singapore, sydney, hongkong, cambodia, taiwan dan permainan live casino online dengan kualitas streaming terbaik."/>
      ...
      <div id="content" class="page-content" data-snap-ignore="true">
        <div class="page-header smartb1">
          <div class="app-container"></div>
			<a class="smartb2" href="https://indratogel176.com/m/index.php"><img class="header-logo2" src="{{ asset('situs/assets/indra_togel/mobile/logo.png') }}" width="130"></a>
		  <div class="buttonlc space smartb3">
			<a href="https://direct.lc.chat/13377213/" class="buttonWrap buttonlc2 button-orange" _blank>Live Chat</a>
		  </div>
                  </div>
...
.owl-wrapper .owl-item .bank .online.smb-mandiri{
	...
	background: url('../../cdn.areabermain.club/indratogel/images/banks/indratogel_online_mandiri.gif') 0px 0px no-repeat !important;
}
.owl-wrapper .owl-item .bank .online.smb-cimb{
	width: 161px !important;
	height: 62px !important;
	background: url('../../cdn.areabermain.club/indratogel/images/banks/indratogel_online_cimb.gif') 0px 0px no-repeat !important;
}
.modal {
	z-index: 105000;
}
...
<div class="inner-wrap">
    ...
    <span style="color:white;margin-right:20px;">&nbsp;&nbsp;07-10-2022</span>
...
<div id='slider-hasil'><div class="slider">
                <div class="results">
                  ...
                  <div class="pool-date">2022-10-07</div>
                  <div class="pool-result">4854</div>
                </div>
                
                <div class="results">
                  <div class="pool-name">CAMBODIA</div>
                  <div class="pool-date">2022-10-07</div>
                  <div class="pool-result">4037</div>
                </div>
                ...
                <div class="results">
                  ...
                  <div class="pool-date">2022-10-06</div>
                  <div class="pool-result">0375</div>
                </div>
                
                <div class="results">
                  <div class="pool-name">HUAHIN 0100</div>
                  <div class="pool-date">2022-10-07</div>
                  <div class="pool-result">8207</div>
                </div>
                </div><div class="slider">
                <div class="results">
                  <div class="pool-name">HUAHIN 1630</div>
                  <div class="pool-date">2022-10-06</div>
                  <div class="pool-result">8760</div>
                </div>
                
                <div class="results">
                  <div class="pool-name">HUAHIN 2100</div>
                  <div class="pool-date">2022-10-06</div>
                  <div class="pool-result">2414</div>
                </div>
                
                <div class="results">
                  <div class="pool-name">BANGKOK 0930</div>
                  <div class="pool-date">2022-10-07</div>
                  <div class="pool-result">4466</div>
                </div>
                
                <div class="results">
                  <div class="pool-name">BANGKOK 0130</div>
                  <div class="pool-date">2022-10-07</div>
                  <div class="pool-result">6380</div>
                </div>
                </div><div class="slider">
        <div class="results">
...
<div>
            ...
            <div class="bank">
              ...
              <img src="{{ asset('situs/assets/indra_togel/mobile/bca.webp') }}" />
            </div>
            <div class="bank">
              <img src="{{ asset('situs/assets/indra_togel/mobile/green-dot.GIF') }}" />
              <img src="{{ asset('situs/assets/indra_togel/mobile/bni.webp') }}" />
            </div>
            <div class="bank">
              <img src="{{ asset('situs/assets/indra_togel/mobile/green-dot.GIF') }}" />
              <img src="{{ asset('situs/assets/indra_togel/mobile/bri.webp') }}" />
            </div>
            <div class="bank">
              <img src="{{ asset('situs/assets/indra_togel/mobile/green-dot.GIF') }}" />
              <img src="{{ asset('situs/assets/indra_togel/mobile/cimb.webp') }}" />
            </div>
            <div class="bank">
              <img src="{{ asset('situs/assets/indra_togel/mobile/green-dot.GIF') }}" />
              <img src="{{ asset('situs/assets/indra_togel/mobile/danamon.webp') }}" />
            </div>
            <div class="bank">
              <img src="{{ asset('situs/assets/indra_togel/mobile/green-dot.GIF') }}" />
            ...
            <div class="bank">
              <img src="{{ asset('situs/assets/indra_togel/mobile/green-dot.GIF') }}" />
              <img src="{{ asset('situs/assets/indra_togel/mobile/maybank.webp') }}" />
            </div>
            <div class="bank">
              <img src="{{ asset('situs/assets/indra_togel/mobile/green-dot.GIF') }}" />
              <img src="{{ asset('situs/assets/indra_togel/mobile/ovo.webp') }}" />
            </div>
            <div class="bank">
              <img src="{{ asset('situs/assets/indra_togel/mobile/green-dot.GIF') }}" />
              <img src="{{ asset('situs/assets/indra_togel/mobile/gopay.webp') }}" />
            </div>
            <div class="bank">
              <img src="{{ asset('situs/assets/indra_togel/mobile/green-dot.GIF') }}" />
              <img src="{{ asset('situs/assets/indra_togel/mobile/dana.webp') }}" />
            </div>
            <div class="bank">
              <img src="{{ asset('situs/assets/indra_togel/mobile/green-dot.GIF') }}" />
              <img src="{{ asset('situs/assets/indra_togel/mobile/linkaja.webp') }}" />
            </div>
            <div class="bank">
              <img src="{{ asset('situs/assets/indra_togel/mobile/green-dot.GIF') }}" />
              <img src="{{ asset('situs/assets/indra_togel/mobile/bsi.webp') }}" />
            </div>     </div>
    </div>
  </div>
</div>
<script language="JavaScript" type="text/javascript">
    $(document).ready(function(){$('.slideshow').cycle({fx:'fade'});});
      ...
      <div class="col-6 col-sm-6">
        <img src="{{ asset('situs/assets/indra_togel/mobile/idnplay_w.png') }}" style="overflow: inherit !important;width: 100%;padding: 10px;margin-top: 7px;">
      </div>
      <div class="col-6 col-sm-6">
        <img src="{{ asset('situs/assets/indra_togel/mobile/pagcorlogo2.png') }}" style="overflow: inherit !important;width: 100%;padding: 10px;">
      </div>
    </div>
    <div class="footer">
      <div class="wrapper">
        <div class="center-text">&copy; 2014 - 2022 indratogel176. All Rights Reserved | 18+</div>
      </div>
    </div>
  </div>
</div></body>
