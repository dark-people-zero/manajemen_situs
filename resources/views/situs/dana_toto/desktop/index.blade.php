...
<body>
                ...
                <div class="col-sm-9 news-body">
                    <ul id="liscroll" style="margin:0px;">
                        <li><a href="javascript:void(0);" style="margin:0px;">
                                <qwe class="run-text-depan"><b>Selamat datang di DANATOTO.COM - Agen togel online
                                        terbaik saat ini - Selamat bergabung dan semoga beruntung.<b></qwe>
                            </a></li>
                    </ul>
                </div>
            </div>
                    ...
                    <ul class="nav menu sidebar-nav">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <i class="fa fa-question-circle"></i>Cara Bermain
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0);">
                                <i class="fa fa-line-chart"></i>History Nomor
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0);">
                                <i class="fa fa-newspaper-o"></i>Buku Mimpi
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0);">
                                <i class="fa fa-users"></i>Referral
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0);">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <i class="fa fa-calendar"></i>Lupa Password
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0);">
                                <i class="fa fa-window-restore"></i>Promosi
                            </a>
                        </li>
                    </ul>
                        ...
                        <div class="vertical-slider">
                            <div class="cycle-slideshow" data-cycle-fx="scrollVert" data-cycle-timeout="3000"
                                ...
                                <div>
                                    ...
                                    <div class="results-detail"><span class="results-pool"
                                            style="margin-right:35px;">Toto Macau</span><span
                                            class="results-number">5358</span></div>
                                    <div class="results-detail"><span class="results-pool"
                                ...
                                <div>
                                    <div class="results-detail"><span class="results-pool"
                                            ...
                                            <div class='rl-ic' style="background-position:-150px 0px"></div>
                                        </span></div>
                                    <div class="results-detail"><span class="results-pool"
                    ...
                    <div class="results">
                        ...
                        <div class="news-detail">
                            <div class="latest-news">
                                ...
                                <br>
                                <span class="dates">2022-09-24 14:10:08</span>
                            </div>
                            <div class="latest-news">
                                ...
                                <br>
                                <span class="dates">2022-09-15 00:33:31</span>
                            </div>
                            <div class="latest-news">
                                ...
                                <br>
                                <span class="dates">2022-09-24 23:08:16</span>
                            </div>
                        </div>
                    </div>
                </div> <!-- BEGIN SLIDER -->
                <div class="col-sm-9 blog-posts">
                    <div id="slider" class="slider">
                        ...
                        <div class="owl-carousel owl-theme">
                            ...
                            <div class="item">
                                <img src="{{ asset('situs/assets/dana_toto/desktop/images/slider/danatoto_sliderweb_allbonus.jpg') }}"
                                    width="840px" height="482" />
                            </div>
                            <div class="item">
                                <img src="{{ asset('situs/assets/dana_toto/desktop/images/slider/danatoto_sliderweb_tipebet2.jpg') }}"
                                    width="840px" height="482" />
                            </div>
                            <div class="item">
                                <img src="{{ asset('situs/assets/dana_toto/desktop/images/slider/danatoto_sliderweb_nominalunik.jpg') }}"
                                    width="840px" height="482" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="row" style="display: flex;">
                            ...
                            <div class="col-3 col-sm-3">
                                <img src="{{ asset('situs/assets/dana_toto/desktop/assets/img/idnplay_w.png') }}"
                                    style="overflow: inherit !important;width: 100%;padding: 10px;margin-top: 7px;">
                            </div>
                            <div class="col-3 col-sm-3">
                                <img src="{{ asset('situs/assets/dana_toto/desktop/assets/img/pagcorlogo2.png') }}"
                                    style="overflow: inherit !important;width: 100%;padding: 10px;">
                            </div>
                            <div class="col-3 col-sm-3"></div>
                        </div>
                        <div class="col-md-12 copyright">
                            &copy; Copyright 2014 - 2022 <a href="#">danatoto176.com</a>. All Rights Reserved.
                        </div>
                    </div>
                </div>
            </div>
    ...
    <style type="text/css">
        @font-face {
            font-family: Muli;
            src: url(/situs/assets/dana_toto/desktop/assets/fonts/Muli.ttf);
        }
