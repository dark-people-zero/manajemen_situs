...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('situs/assets/togel_on/mobile/tingle.min.css') }}">
    <link href="{{ asset('situs/assets/togel_on/mobile/style.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('situs/assets/togel_on/mobile/style(1).css') }}" rel="stylesheet" type="text/css">
    <style type="text/css">
        .footer {
            z-index: 1;
        }
    </style>
    <link href="{{ asset('situs/assets/togel_on/mobile/framework.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('situs/assets/togel_on/mobile/owl.carousel.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('situs/assets/togel_on/mobile/owl.theme.css') }}" rel="stylesheet" type="text/css">
    ...
    <script type="text/javascript" src="{{ asset('situs/assets/togel_on/mobile/jquery.swipebox.js.download') }}"></script>
    <script type="text/javascript" src="{{ asset('situs/assets/togel_on/mobile/jquery.colorbox.js.download') }}"></script>
    <script type="text/javascript" src="{{ asset('situs/assets/togel_on/mobile/snap.js.download') }}"></script>
    <script type="text/javascript" src="{{ asset('situs/assets/togel_on/mobile/contact.js.download') }}"></script>
    <script type="text/javascript" src="{{ asset('situs/assets/togel_on/mobile/custom.js.download') }}"></script>
    <script type="text/javascript" src="{{ asset('situs/assets/togel_on/mobile/framework.js.download') }}"></script>
    <script type="text/javascript" src="{{ asset('situs/assets/togel_on/mobile/framework.launcher.js.download') }}">
    </script>
    <script language="JavaScript" type="text/javascript"
        src="{{ asset('situs/assets/togel_on/mobile/jquery-cycle-all-pack.js.download') }}"></script>
    <script type="text/javascript" src="{{ asset('situs/assets/togel_on/mobile/clipboard.min.js.download') }}"></script>
    <script type="text/javascript" src="{{ asset('situs/assets/togel_on/mobile/clipboard.js.download') }}"></script>
    <script src="{{ asset('situs/assets/togel_on/mobile/notif-widget.js.download') }}"></script>
    ...
    <div class="all-elements">
        <div id="content" class="page-content" data-snap-ignore="true">
            <div class="page-header smartb1">
                ...
                <a class="smartb2" href="https://tglon.com/m/index.php"><img class="header-logo2"
                        src="{{ asset('situs/assets/togel_on/mobile/logo.png') }}" width="130"></a>
                <div class="buttonlc space smartb3">
                    <a href="https://direct.lc.chat/13379157/" class="buttonWrap buttonlc2 button-orange"
                        _blank="">Live Chat</a>
                </div>
            </div>
            ...
            <div class="content smartb4">
                <div class="container main no-bottom">
                    <div class="wrapper2">
                        ...
                        <div>
                            <script type="text/javascript" src="{{ asset('situs/assets/togel_on/mobile/vbulletin_md5.js.download') }}"></script>
                            <form action="https://tglon.com/m/index.php" method="post"
                                ...
                                <div class="form-group">
                                    <span class="showp" onclick="showpassword()"><img
                                            src="{{ asset('situs/assets/togel_on/mobile/eye.png') }}">
                                ...
                                <div>
                                    <a href="https://tglon.com/m/forget-password.php"
                                        class="note right underline">Lupa password?</a>

                                    <a href="https://tglon.com/lite/index.php" class="note left underline">Lite
                                        Mode</a>
                            ...
                            <div class="buttonjoin">
                                <a href="https://tglon.com/m/register.php"
                        ...
                        <div class="panel-blue">
                            ...
                            <div id="slider-hasil">
                                ...
                                <div class="slider">
                                    <div class="results">
                                        ...
                                        <div class="pool-result"><img
                                                src="{{ asset('situs/assets/togel_on/mobile/11.png') }}"
                                                width="22px"></div>
                                    </div>
                                    <div class="results">
                                        ...
                                        <div class="pool-date"></div>
                                        <div class="pool-result"><img
                                                src="{{ asset('situs/assets/togel_on/mobile/dice4.png') }}"
                                ...
                                <div class="slider">
                                    <div class="results">
                                        ...
                                        <div class="pool-date"></div>
                                        <div class="pool-result"><img
                                                src="{{ asset('situs/assets/togel_on/mobile/22.png') }}"
                                                width="22px"></div>
                                    </div>
                                    <div class="results">
                                        ...
                                        <div class="pool-result"><img style="margin: 6px 1px;"
                                                src="{{ asset('situs/assets/togel_on/mobile/dice2.png') }}"><img
                                                style="margin: 6px 1px;"
                                                src="{{ asset('situs/assets/togel_on/mobile/dice3.png') }}"><img
                                                style="margin: 6px 1px;"
                                                src="{{ asset('situs/assets/togel_on/mobile/dice5.png') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="bank">
                                    ...
                                    <img src="{{ asset('situs/assets/togel_on/mobile/bca.webp') }}">
                                </div>
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/togel_on/mobile/green-dot.GIF') }}">
                                    <img src="{{ asset('situs/assets/togel_on/mobile/bni.webp') }}">
                                </div>
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/togel_on/mobile/green-dot.GIF') }}">
                                    <img src="{{ asset('situs/assets/togel_on/mobile/bri.webp') }}">
                                </div>
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/togel_on/mobile/green-dot.GIF') }}">
                                    <img src="{{ asset('situs/assets/togel_on/mobile/cimb.webp') }}">
                                </div>
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/togel_on/mobile/green-dot.GIF') }}">
                                    <img src="{{ asset('situs/assets/togel_on/mobile/dana.webp') }}">
                                </div>
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/togel_on/mobile/green-dot.GIF') }}">
                                    <img src="{{ asset('situs/assets/togel_on/mobile/danamon.webp') }}">
                                </div>
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/togel_on/mobile/green-dot.GIF') }}">
                                    <img src="{{ asset('situs/assets/togel_on/mobile/gopay.webp') }}">
                                </div>
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/togel_on/mobile/red-dot.GIF') }}">
                                ...
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/togel_on/mobile/green-dot.GIF') }}">
                                    <img src="{{ asset('situs/assets/togel_on/mobile/maybank.webp') }}">
                                </div>
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/togel_on/mobile/green-dot.GIF') }}">
                                    <img src="{{ asset('situs/assets/togel_on/mobile/ovo.webp') }}">
                                </div>
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/togel_on/mobile/green-dot.GIF') }}">
                                    <img src="{{ asset('situs/assets/togel_on/mobile/panin.webp') }}">
                                </div>
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/togel_on/mobile/green-dot.GIF') }}">
                                    <img src="{{ asset('situs/assets/togel_on/mobile/linkaja.webp') }}">
                                </div>
                                <div class="bank">
                                    <img src="{{ asset('situs/assets/togel_on/mobile/red-dot.GIF') }}">
                                    <img src="{{ asset('situs/assets/togel_on/mobile/bsi.webp') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row" style="display: flex;">
                    <div class="col-6 col-sm-6">
                        <img src="{{ asset('situs/assets/togel_on/mobile/idnplay_w.png') }}"
                            style="overflow: inherit !important;width: 100%;padding: 10px;margin-top: 7px;">
                    </div>
                    <div class="col-6 col-sm-6">
                        <img src="{{ asset('situs/assets/togel_on/mobile/pagcorlogo2.png') }}"
                            style="overflow: inherit !important;width: 100%;padding: 10px;">
                    </div>
                </div>
                <div class="footer">
                    <div class="wrapper">
                        <div class="center-text">© 2014 - 2022 tglon. All Rights Reserved | 18+</div>
                    </div>
                </div>
            </div>
        </div>

        <script type="text/javascript" src="{{ asset('situs/assets/togel_on/mobile/_footer.js.download') }}"></script>
        <script src="{{ asset('situs/assets/togel_on/mobile/moment.min.js.download') }}" type="text/javascript"></script>
